...
########################################################################
define("WEB_DOMAIN", "najah.online"); //ex. demo.orangescrum.com
define('FROM_EMAIL_NOTIFY', 'notify@mycompany.com'); //(REQUIRED)
define('SUPPORT_EMAIL', 'support@mycompany.com'); //(REQUIRED) From Email
define('FROM_EMAIL',  'مشروع نجاح<'.SUPPORT_EMAIL.'>');

define("DEV_EMAIL", 'developer@mycompany.com'); // Developer Email ID to report the application error
define('EMAIL_SUBJ', '[مشروع نجـاح]');

// If you have not yet set up the Nohup cronjob, leave it blank
define('EMAIL_REPLY', "<div style='font-family:Arial;font-size:14px;color:#787878;margin-bottom:5px;'>Just REPLY to this Email the same will be added under the Task. <br/><span style='font-size:11px;'><b>NOTE:</b> الرجاء عدم تغيير محتوى الرسالة.</span></div>");
...
if(php_sapi_name() === "cli") {
	...
	define('DOMAIN', "www.najah.online/"); // Please set your application domain (REQUIRED)
}else{
