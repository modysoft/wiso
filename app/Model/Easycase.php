                ...
                if($caseTypeId == 10 || $caseLegend == 3 || $caseLegend == 5) {
                    ...
                    if($caseDueDate != "NULL" && $caseDueDate != "0000-00-00" && $caseDueDate != "" && $caseDueDate != "1970-01-01") {
                        if($caseDueDate < $curdtT) {
                            $csDuDtFmtT = $dt->facebook_datestyle($caseDueDate);
                            $csDuDtFmt = '<span class="over-due">متأخر</span>';
                        ...
                        $csDuDtFmtT = '';
                        $csDuDtFmt = '<span class="set-due-dt">حدد التاريخ</span>';
                        $csDueDate = '';
                    }
                }
    ...
    function formatReplies($sqlcasedata, $allUserArr, $frmt, $cq, $tz, $dt) {
        ...
        foreach($sqlcasedata as $caseKey => $getdata) {
            ...
            if($caseReplyType == 0 && $caseDtMsg != '') {
                if($caseDtLegend == 1) {
                    $sts = '<b class="new">جديـدة</b>';
                } elseif($caseDtLegend == 2 || $caseDtLegend == 4) {
                    $sts = '<b class="wip">متقدمـة</b>';
                } elseif($caseDtLegend == 3) {
                    $sts = '<b class="closed">مغلقـة</b>';
                } elseif($caseDtLegend == 5) {
                    $sts = '<b class="resolved">منتهـية</b>';
                }
            ...
            if($caseReplyType == 0 && ($caseDtMsg == '' || $caseDtLegend==6)) {
                if($caseDtLegend == 3) {
                    $replyCap = ' المهمــة <b class="closed">مغلقة</b>';
                } elseif($caseDtLegend == 4) {
                    $replyCap = 'المهمــة <b class="wip">بدأت</b> ';
                } elseif($caseDtLegend == 5) {
                    $replyCap = 'المهمــة <b class="resolved">منتهية</b> ';
                }elseif($caseDtLegend == 6) {
                    $replyCap = 'المهمــة <b class="resolved">معدلة</b> ';
                }
            } else {
                if($caseReplyType == 1) {
                    ...
                    $replyCap = 'تمت إعادة تعيين المهمة ل <b class="ttc">'.$by_name_assign.' '.$by_last_name_assign.'</b>';
                    ...
                    if($caseDtDue != "NULL" && $caseDtDue != "0000-00-00" && $caseDtDue != "" && $caseDtDue != "1970-01-01") {
                        ...
                        $replyCap = 'Due Date: <i>لا يوجد تاريخ إستحقاق</i>';
                    }
                }elseif($caseReplyType == 4) {
                    $casePriority = $getdata['Easycase']['priority'];
                    if($casePriority == 0) {
                        $replyCap = 'تم تغيير الأولوية إلى <b class="pr_high">عالي</b><br/>';
                    }elseif($casePriority == 1) {
                        $replyCap = 'تم تغيير الأولوية إلى <b class="pr_medium">متوسط</b><br/>';
                    }elseif($casePriority == 2) {
                        $replyCap = 'تم تغيير الأولوية إلى <b class="pr_low">منخفض</b><br/>';
                    }
                }
            }
...
//        pr($milestones);die;
        ...
        if($milestones) {
            ...
            if($projUniq) {
                ...
                $curCreated = $tz->GetDateTime(SES_TIMEZONE,TZ_GMT,TZ_DST,TZ_CODE,GMT_DATETIME,"datetime");
                $thursday = date('Y-m-d',strtotime($curCreated."next Friday"));
                $sunday = date('Y-m-d',strtotime($curCreated."next Monday"));
