...
<span id="taskAddBtns" style="display:none;">
	<button class="btn btn_blue" id="confirmusercls"  value="Confirm" type="button" onclick="remove_cases_template();"><i class="icon-big-tick"></i>إزالة</button>
	...
	<table cellpadding="0" cellspacing="0" class="col-lg-12 ad_prj_usr_tbl">
		...
		<tr class="rw-cls">
			<td align="center">
				<div class="add-tmp-btn">
				<span id="excptAddContinue" >
					<button class="btn btn_add_task_template" type="button" onclick="addTempToTask('<?php echo $template_id; ?>', '', 1)">إضافة مهمة الى القالب</button>
				</span>
				</div>
			</td>
		</tr>
