	   ...
	   ?>
		...
		<div class="col-lg-4 proj_mng_div">
			<div class="col-lg-12 contain usr_mng_div">
				...
				<div class="proj_mng">
					<div class="fl">
						<a href="javascript:void(0);" class="icon-add-task fl" onclick="addTempToTask('<?php echo $template['project_templates']['id']; ?>', '<?php echo addslashes($template['project_templates']['module_name']); ?>', 0);">إضافة مهمة</a><br/>
						<a href="javascript:void(0);" class="icon-remov-task fl" onclick="removeTaskFromTemp('<?php echo $template['project_templates']['id']; ?>', '<?php echo addslashes($template['project_templates']['module_name']); ?>');">إدارة المهمة</a>
					</div>
					<div class="fr">
						<a href="javascript:void(0);" class="icon-edit-task fl" onclick="EditTask('<?php echo $template['project_templates']['id']; ?>', '<?php echo addslashes($template['project_templates']['module_name']); ?>', '<?php echo $casePage; ?>');">تعديل</a><br/>
						<a href="javascript:void(0);" onclick="deltemplate('<?php echo $template['project_templates']['id']; ?>', '<?php echo addslashes($template['project_templates']['module_name']); ?>');" class="icon-delete-usr fl" >حذف</a>
					</div>
				</div>
			</div>
		</div>
