                                ...
                                <td>
                                    ...
                                    <?php echo $this->Form->create('User',array('url'=>'/users/forgotpassword','onsubmit'=>'return validpwd(\'email\')')); ?>
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                              <td>
                                              	<h6>لإعادة تعيين كلمة السر، اكتب عنوان البريد الإلكتروني الكامل الذي تستخدمه لتسجيل الدخول إلى حسابك</h6>
                                              </td>
                                            </tr>
                                                <td align="center">
                                            ...
                                            <tr>
                                            <td>
												<label class="lbl_ie">البريد الإلكتروني</label>
                                                <?php echo $this->Form->text('email',array('size'=>'60','id'=>'email','maxlength'=>'100','placeholder'=>'البريد الإلكتروني','title'=>'Email ID','class'=>'textbox')); ?>
                                            </td>
                                            </tr>
                                            <tr >
                                                <td align="left">
                                                    ...
                                                    <div id="fgpass">
                                                        <div class="fl" style="margin-left:20px; margin-top:10px;">
                                                            <button type="submit" value="Submit" name="submit_pwd"class="btn btn_blue" style="cursor:pointer">أرسل</button>
                                                            <span class="or_cancel">or<a href="<?php echo HTTP_ROOT; ?>users/login">إلغاء</a></span>
                                                        </div>
                                                        <div class="cb"></div>
                                                    </div>
                                                    <div class="cb"></div>
                                    ...
                                    <?php echo $this->Form->create('User',array('url'=>'/users/forgotpassword','onsubmit'=>'return validatepass()')); ?>
                                        ...
                                        <tr>
                                        <td>
                                        <div style="padding-bottom:10px"><h2 style="">أعد ضبط كلمه السر</h2></div>
                                        ...
                                        <tr height="5px"><td>
                                        <?php echo $this->Form->password('newpass',array('size'=>'60','id'=>'newpass','maxlength'=>'15','onKeyPress'=>'return noSpace(event)','autocomplete'=>'off','placeholder'=>'كلمة السر الجديدة','title'=>'New Password','class'=>'textbox')); ?>
                                        
                                        </td>
                                        </tr>
                                        <tr height="5px"><td>
                                        <?php echo $this->Form->password('repass',array('size'=>'60','id'=>'repass','maxlength'=>'15','onKeyPress'=>'return noSpace(event)','autocomplete'=>'off','placeholder'=>'إعادة تأكيد كلمة السر الجديدة','title'=>'Re-type Passowrd','class'=>'textbox')); ?>
                                        </td>
                                        </tr>
                                        ...
                                        <button type="submit" value="Submit" name="submit_pwd" class="btn btn_blue" style="cursor:pointer">تأكيد العملية</button>
                                        <span class="or_cancel"><a href="<?php echo HTTP_ROOT; ?>users/login">إلغاء العملية</a>أو</span>
                                        </span>
                                    ...
                                    <?php if($chkemail=="10"){?>
                                        ...
                                        <tr>
											<td>
											<div style=" margin-top:0px; margin-bottom:10px"><h2 style="color:#379B37; font-size:20px;">تم تغيير كلمة المرور بنجاح<h3></div>
											<div><img src="<?php echo HTTP_ROOT; ?>img/images/login_header_shadow.png?v=<?php echo RELEASE; ?>"></div>
											</td>
											</tr>
											<tr>
											<td>
	<h2 style="color:#000; font-size:20px;"><a href="<?php echo HTTP_ROOT;?>users/login" style="color:blue;text-decoration:underline;">سجل</a>  باستعمال كلمة السر الجديدة </a></h2>
											</span>
											</td>
                                        </tr>
