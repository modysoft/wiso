...
<table cellpadding="0" cellspacing="0" border="0"  width="960px" style="padding-bottom:4px">
	<tr>
		<td align="left" valign="top" colspan="6" style="padding:0 0 10px 0">
			<span style="font:bold 12px verdana;color:#F86402">حدد المشاريع</span>
		</td>
	 </tr>
	<?php
	$s=0;
	...
	<tr>
		<td colspan="7" align="right">
			<span class="makeHover_new" style="color:#F9731B;cursor:pointer" onclick="displayAllProjects('<?php echo $page; ?>','disabled');">المشاريع المقفلة</span>
		</td>
	</tr>
	<?php
	}
	...
	<tr>
		<td colspan="7" align="right">
			<span class="makeHover_new" style="color:#F9731B;cursor:pointer;" onclick="displayAllProjects('<?php echo $page; ?>','enabled');">المشاريع المفعلة</span>
		</td>
	</tr>
	<?php
	}
