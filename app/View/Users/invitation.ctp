...
<?php
if($AuthId) {
	echo "<div style='color:#FF0000'>الرجاء الخروج من نظام المهام ثم النقر على نفس الرابط الذى وصلك عن طريق البريد لتأكيد المشاركة.</div>";
}
else {
?>
        ...
        <div <?php if(PAGE_NAME == "home") { ?>class="home" <?php } else { ?>class="home_other" <?php } ?> style="height:100%;display:table">
            <!--<td style="vertical-align:middle; height:100%">-->
                <div id="container" style="display:table-cell; vertical-align:middle">
                    <!--<tr>
                                ...
                                <!--<div style="float:right; width: 50%;" class="login_dtls">
                                    ...
                                    <div class="login_box">
                                        <div class="login_dialog" id="login_dialog">
											...
											<div id="divide"></div>
												<div class="join_txt"><h2>سجل بسهولة</h2></div>
					  ...
					  <label class="lbl_ie">الإسم</label>
                        <?php echo $this->Form->text('name',array('size'=>'45','maxlength'=>'100','autocomplete'=>'off','placeholder'=>'الإسم', 'id'=>'name', 'style'=>'background:#fff')); ?>
			<input type="hidden" value="<?php echo $email;?>" name="invited_email" id="invited_email"/>
		       ...
		       <?php echo $this->Form->text('last_name',array('size'=>'45','maxlength'=>'100','autocomplete'=>'off','placeholder'=>'Last Name', 'id'=>'last_name', 'style'=>'background:#fff')); ?>
                       ...
                       <label class="lbl_ie">كلمة السر</label>
					   <?php echo $this->Form->password('password',array('size'=>'45','size'=>'32','maxlength'=>'15','onKeyPress'=>'return noSpace(event)','autocomplete'=>'off','placeholder'=>'كلمة السر', 'id'=>'pas_new', 'style'=>'background:#fff')); ?>
                        
                         <div class="gap10"></div>      
                            <!--<h2 style="font-weight:normal;color:#8a8a8a;font-weight:bold" class="sign_lable"><b>تأكيد كلمة السر:</b></h2>-->
                       <!-- <?php echo $this->Form->password('pas_retype',array('id'=>'pas_retype','size'=>'32','maxlength'=>'15','onKeyPress'=>'return noSpace(event)','autocomplete'=>'off')); ?>-->
                        <label class="lbl_ie">تأكيد كلمة السر</label>
                         <?php echo $this->Form->password('pas_retype',array('size'=>'45','size'=>'32','maxlength'=>'15','onKeyPress'=>'return noSpace(event)','autocomplete'=>'off','placeholder'=>'تأكيد كلمة السر', 'id'=>'pas_retype', 'style'=>'background:#fff')); ?>
                         <div class="gap10"></div>      
                        <?php
                        if($qstr)
                        {
