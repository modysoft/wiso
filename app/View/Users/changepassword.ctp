...
<table cellspacing="0" cellpadding="0" class="col-lg-5" style="text-align:left;">
    <tbody>
		...
		<?php /*<button type="submit" value="<?php if(NO_PASSWORD){echo 'Set';}else{ echo 'Change';}?>" name="submit_Pass"  id="submit_Pass" class="btn btn_blue" onclick="document.getElementById('changepass').value='1'"><i class="icon-big-tick"></i>تغيير</button> */ ?>
		<button type="button" value="<?php if(NO_PASSWORD){echo 'Set';}else{ echo 'Change';}?>" name="submit_Pass"  id="submit_Pass" class="btn btn_blue" onclick="$('#changepass').val('1');checkCsrfToken('UserChangepasswordForm');"><i class="icon-big-tick"></i>تغيير</button>
