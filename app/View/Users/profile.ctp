...
<table cellspacing="0" cellpadding="0" class="col-lg-5" style="text-align:left;">
	...
	<tr>
	    ...
	    <th></th>
            <td class="btn_align">
		<span id="subprof1">
		    <?php /* <button type="submit" value="Update" name="submit_Profile"  id="submit_Profile" class="btn btn_blue"><i class="icon-big-tick"></i>تحديث</button> */ ?>
		    <button type="button" value="Update" name="submit_Profile"  id="submit_Profile" class="btn btn_blue" onclick="checkCsrfToken('UserProfileForm');"><i class="icon-big-tick"></i>تحديث</button>
		    ...
		    <!--<a href="<?php //echo $referer; ?>">إلغاء</a>-->
		</span>
