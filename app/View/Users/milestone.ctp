	...
	<div class="col-lg-12 m-left-20">
		...
		<div class="col-lg-4 proj_mng_div">
			<div class="col-lg-12 contain">
				...
				<div class="cb"></div>
				<div class="proj_mng">
					<a href="javascript:void(0);" class="icon-add-usr fl" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>">إضافة مستخدم</a>
