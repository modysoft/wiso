            ...
            <tr>
                ...
                <td class="btn_align btn_eml_lt">
                    <span id="subprof1">
                        ...
                        <button type="button" value="Save" name="submit_Pass"  id="submit_Pass" class="btn btn_blue" onclick="checkCsrfToken('UserNotificationEmailReportsForm');"><i class="icon-big-tick"></i>تحديث</button>
