...
<table cellspacing="0" cellpadding="0" class="col-lg-5" style="text-align:left;">
    <tbody>
		...
		<?php /* <button type="submit" value="Update" name="submit_Pass"  id="submit_Pass" class="btn btn_blue"><i class="icon-big-tick"></i>تحديث</button> */ ?>
		<button type="button" value="Update" name="submit_Pass"  id="submit_Pass" class="btn btn_blue" onclick="checkCsrfToken('CompanyMycompanyForm');"><i class="icon-big-tick"></i>تحديث</button>
