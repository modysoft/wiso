<div id="crt_new_user" class="onbording_main_div" style="margin-top:-10%;">
	<div class="on_brd">
		<div class="on_brd">لقد وصلت إلى هنا، مما يعني أن الخطوة الأولى تمت بنجاح </div>
		<div>  نظــام إدارة المهــام والمتابعـة، يعمل بشكل أفضل عند إضافة زمـلاء العمـل</div>
		<div class=" fl"   style="padding:7px 12px;background:#ff7800;color:#fff;border:1px solid #fff;font-size:15px; margin-top:20px">
			...
			<div class="fl" style="margin: 2px;">
				<a href="javascript:void(0);" <?php if(ACCOUNT_STATUS!=2){?> onclick="newUser('menuid1','loaderid1');" <?php }?> style="text-decoration: none;color: #fff; font-weight: bold; font-size: 14px;" > دعوة مستخدم</a>
			</div>
		</div>
