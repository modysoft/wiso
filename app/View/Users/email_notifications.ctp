...
<tr>
		...
		<?php /* <button type="submit" value="Save" name="submit_Pass"  id="submit_Pass" class="btn btn_blue"><i class="icon-big-tick"></i>تحديث</button> */ ?>
		<button type="button" value="Save" name="submit_Pass"  id="submit_Pass" class="btn btn_blue" onclick="checkCsrfToken('UserNotificationEmailNotificationsForm');"><i class="icon-big-tick"></i>تحديث</button>
