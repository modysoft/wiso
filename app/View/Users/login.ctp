        ...
        <div style="display:table-cell; height:100%; min-height:100%; vertical-align:middle">
            <div style="position:relative; z-index:9;">
                ...
                <div class="logo_landing">-->
                    <a href="<?php echo HTTPS_HOME; ?>"><img src="<?php echo HTTP_ROOT; ?>img/images/logo_outer.png?v=<?php echo RELEASE; ?>"  border="0" alt="Najah.Online" title="Najah.Online"/></a>
                    <?php
					if(!$findCompany['Company']['id']) {
						?>
                        <h4>إدارة التخطيط والمتابعــــة</h4>
                    ...
                    <div style="height:100%;display:table; width:100%;">
					   ...
					   <div style="text-align:center;">
						...
						?>
                                            ...
                                            if(!$findCompany['Company']['id']) {
                                             ?>
                                                 <label class="lbl_ie">إسم الإدارة</label>
												<?php echo $this->Form->text('company', array('size' => '30', 'class' => 'textbox', 'placeholder' => 'إسم الإدارة', 'title' => 'Company Name', 'id' => 'company', 'style' => 'background:#fff')); ?>
                                            ...
                                            <label class="lbl_ie">البريد الألكتروني</label>
                                            <?php echo $this->Form->text('email', array('size' => '30', 'class' => 'textbox', 'placeholder' => 'البريد الألكتروني', 'title' => 'Email ID', 'id' => 'email', 'style' => 'background:#fff')); ?>

                                            <label class="lbl_ie">Password</label>
                                            <?php echo $this->Form->password('password', array('size' => '30', 'class' => 'textbox', 'placeholder' => 'كلمة السر', 'title' => 'Password', 'id' => 'password')); ?>
                                            <div class="gap10"></div>
                                            ...
                                            <div style="margin-left:20px; margin-top:4px;">
                                                ...
                                                <span class="rem_posn" style="color:#666;">إحفظ معلومات التسجيل </span>
                                            </div>
                                            <div class="gap10"></div>
                                            <div>
                                                <div style="margin-top:0px; margin-left:20px;" class="fl">
                                                    <input type="hidden" value="" name="case_details" id="case_details" />
                                                    <button type="submit" value="Save" name="submit_Pass" id="submit_Pass" class="btn btn_blue">تسجيل الدخول</button> <!--Or &nbsp;-->
                                                ...
                                                <div style="margin-left:10px;margin-top:10px;margin-bottom:20px;" class="fl or_cancel"><a href="<?php echo HTTP_ROOT; ?>users/forgotpassword" class="forgot_pwd"> نسيت كلمة السر؟</a></div>
                                                <?php
                                                }
                                                else {
                                                ?>
                                                ...
                                                <br/><br/>
                                                <button type="button" value="Signup" name="submit_button" id="submit_button" class="btn btn_blue" onclick="return validateForm()">سجـــل</button>
                                    ...
                                    <div style="padding:20px 0;text-align:center">
                                        <br/>
                                    	مشروع نجـــاح هو الخطة التنفيذية، التي بموجبها تقوم وزارة المالية بتطبيق فلسفة إدارية جديدة تقوم على قياس الأداء المؤسسي للهياكل التنظيمية التابعة لها لتقدير العائد الحقيقي من الأعمال والإنجازات وتوافقها مع مستهدفات استراتيجية الوزارة بما يعزز الأولويات وترشيد الإنفاق
