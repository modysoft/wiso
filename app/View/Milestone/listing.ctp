<div class="col-lg-12 m-left-20">
		...
		<div class="col-lg-4 proj_mng_div">
			<div class="col-lg-12 contain">
				...
				<div class="proj_mng">
				    <div class="fl">
					<a href="javascript:void(0);" class="icon-add-task fl" onClick="addTaskToMilestone(this);" data-prj-id="<?php echo $milestone['Milestone']['project_id'];?>" data-id="<?php echo $milestone['Milestone']['id'];?>">إضافة مهمة</a>
					<br />
					<?php if($type == 'completed') { ?>
					<a href="javascript:void(0);" class="icon-restore-mlstn fl" onClick="milestoneRestore(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>">إستعادة</a>
					<?php } else { ?>
					<a href="javascript:void(0);" class="icon-complete-mlstn fl" onClick="milestoneArchive(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>">إكمال</a>
					<?php } ?>
				    </div>
				    <div class="fr">
					<a href="javascript:void(0);" class="icon-edit-mlstn fl" onClick="addEditMilestone(this);" data-id="<?php echo $milestone['Milestone']['id'];?>" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>">تعديل</a>
					<br />
					<a href="javascript:void(0);" class="icon-delete-mlstn fl" onClick="delMilestone(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>">حذف</a>
				    </div>
				</div>
			</div>
		</div>
