	...
	<?php
		...
		<tr id="listings<?php echo $count; ?>" class="rw-cls <?php echo $class; ?>">	
			...
			if ($casePriority == "NULL" || $casePriority == "") {
			    ...
			    echo "<span class='tag red' title='عالي' rel='tooltip'>&nbsp;</span>";
			} elseif ($casePriority == 1) {
			    echo "<span class='tag orange' title='متوسط' rel='tooltip'>&nbsp;</span>";
			} elseif ($casePriority >= 2) {
			    echo "<span class='tag green' title='منخفض' rel='tooltip'>&nbsp;</span>";
			}
			?>
		    </td>
