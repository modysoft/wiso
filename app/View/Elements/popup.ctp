...
<div class="popup_bg">
	...
	<div class="popup_title">
	    <span><i class="icon-create-proj"></i> إنشاء مشروع جديد</span>
	...
	<div class="popup_form">
		...
		<form name="task_type" id="customTaskTypeForm" method="post" action="<?php echo HTTP_ROOT."projects/addNewTaskType"; ?>" autocomplete="off">
			...
			<span id="ttbtn">
			    <button id="newtask_btn" type="button" value="Add" onclick="return validateTaskType();" name="crttasktype" class="btn btn_blue"><i class="icon-big-tick"></i>إضافة</button>
			    <span class="or_cancel">
			       <a onclick="closePopup();">إلغاء</a>
			   </span>
			</span>
		    </div>
		</form>
		...
		<!--	<tr>
			...
			<tr>
				...
				<div id="actConfirmbtn" style="display:none;">
				    <button type="button" value="Confirm" class="btn btn_blue file_confirm_btn" onclick="doneCropImage()"><i class="icon-big-tick"></i>تأكيد</button>
				    ...
				    <button class="btn btn_grey reset_btn file_confirm_btn" type="button" Onclick="profilePopupCancel();" ><i class="icon-big-cross"></i>إلغاء</button>
				</div>
				<div id="inactConfirmbtn" style="display:block;">
				    <button type="button" value="Confirm" class="btn btn_blue btn_impcsv" disabled="disabled" onclick="javascript:void(0);"><i class="icon-big-tick"></i>تأكيد</button>
				    <button class="btn btn_grey reset_btn" type="button" Onclick="profilePopupCancel();" ><i class="icon-big-cross"></i>إلغاء</button>
				</div>
			    </td>
			</tr>	
		    </table>
	...
	<div class="popup_title pad-10">
	    <div class="hdr-cnt fl">إزالة المستخدم</div>
	...
	<div class="popup_form">
		...
		<span id="rmv_btn">
		    <button class="btn btn_blue" id="rmvbtn"  value="Remove" type="button" onclick="removeusers()"><i class="icon-big-tick"></i>إزالة</button>
		    <!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
            <span class="or_cancel"><a onclick="closePopup();">إلغاء</a></span>
		</span>
		</center>
	    </div>
	</div>
	...
	<div class="popup_title pad-10">
	    <div class="hdr-cnt fl">إضافة مستخدم </div>
		<div class="fl"><img src="<?php echo HTTP_IMAGES; ?>html5/icons/icon_breadcrumbs.png"></div>
	...
	<div class="popup_form">
		...
		<span id="confirmbtn" style="display:block;">
		    <button class="btn btn_blue" id="confirmusercls" value="Confirm" type="button" onclick="assignuser(this)"><i class="icon-big-tick"></i>إضافة</button>
		    <button class="btn btn_blue" id="confirmuserbut" value="Confirm" type="button" onclick="assignuser(this)"><i class="icon-big-tick"></i>إضافة و متابعة</button>
		    <!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
                    <span class="or_cancel">
                        <a onclick="closePopup();">إلغاء</a>
                    </span>
	...
	<div class="popup_form">
		...
		<span id="confirmbtnprj" style="display:block;">
		    <button class="btn btn_blue" id="confirmprjcls" value="Confirm" type="button" onclick="assignproject(this)"><i class="icon-big-tick"></i>تعيين</button>
		    <button class="btn btn_blue" id="confirmprjbut" value="Confirm" type="button" onclick="assignproject(this)"><i class="icon-big-tick"></i>تعيين ومتابعة</button>
		    <!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
            <span class="or_cancel"><a onclick="closePopup();">إلغاء</a></span>
		</span>
	    </div>
	...
	<div class="popup_title pad-10">
	    <span class="hdr-cnt">إزالة المشروع
		<span><img src="<?php echo HTTP_IMAGES; ?>html5/icons/icon_breadcrumbs.png"></span>
	...
	<div class="popup_form">
		...
		<span id="rmv_prj_btn">
		    <button class="btn btn_blue" id="rmvprjbtn"  value="Remove" type="button" onclick="removeprojects()"><i class="icon-big-tick"></i>إزالة</button>
		    <!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
            <span class="or_cancel"><a onclick="closePopup();">إلغاء</a></span>
		</span>
		</center>
	...
	<div class="popup_title">
	    <span><i id="icon_mlstn" class="icon-create-proj"></i><div id="header_mlstn" class="fl mlstn_nm_long">إنشاء معلم في المشروع</div></span>
	    <a href="javascript:jsVoid();" onclick="closePopup();"><div class="fr close_popup">X</div></a>
	</div>
	<div class="popup_form">
	...
	<div class="popup_form" style="position: relative;">
		...
		<span id="confirmbtntsk" style="display:block;">
		    <button class="btn btn_blue showhidebtn" id="addtsk" value="Add" type="button" onclick="assignCaseToMilestone(this)"><i class="icon-big-tick"></i>إضافة</button>
		    <button class="btn btn_blue showhidebtn" id="addtskncont" value="Add" type="button" onclick="assignCaseToMilestone(this)"><i class="icon-big-tick"></i>إضافة و متابعة</button>
		    <!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
            <span class="or_cancel">
	...
	<div class="popup_form">
		...
		<center>
			...
			<span id="mvtask_confirmbtn" style="display:block;">
				<button class="btn btn_blue" id="mvtask_movebtn" value="Add" type="button" onclick="switchTaskToMilestone(this)"><i class="icon-big-tick"></i>نقل المهمة</button>
				<!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
                <span class="or_cancel"><a onclick="closePopup();">إلغاء</a></span>
			</span>
			</center>
	...
	<div class="popup_form">
	    ...
	    <div class="add-mlstn-btn" style="display: none;">
			<center>
				...
				<span id="confirmbtntsk" style="display:block;">
					<button class="btn btn_blue" id="addtsk" value="Add" type="button" onclick=" return removecaseFromMilestone(this)"><i class="icon-big-tick"></i>إزالة</button>
					<!--<button class="btn btn_blue" id="addtskncont" value="Add" type="button" onclick="assignCaseToMilestone(this)"><i class="icon-big-tick"></i>إضافة و متابعة</button>-->
					<!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
                    <span class="or_cancel"><a onclick="closePopup();">إلغاء</a> </span>
				</span>
			</center>
	...
	<div class="popup_form">
		...
		<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
			...
			<td class="btn_align">
			    ...
			    <span id="spt_btn">
				<button class="btn btn_blue" type="button" value="Post" name="addMember" onclick="postSupport();action_ga('Feedback Post');"><i class="icon-big-tick"></i>أرسل</button>
				<!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
                <span class="or_cancel">
			...
			<div id="inner_task_temp">
				...
				<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
					...
					<td class="btn_align">
						...
						<span id="task_btn">
							<button class="btn btn_blue" type="button" onclick="createTaskTemplate('add')"><i class="icon-big-tick"></i>إنشاء</button>
							<!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>الغاء</button>-->
                            <span class="or_cancel">or<a onclick="closePopup();">إلغاء</a></span>
						</span>
					</td>
					</tr>
				</table>
			...
			<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab">
				...
				<td class="btn_align">
					...
					<span id="task_btn_edit">
						<button class="btn btn_blue" type="button" onclick="createTaskTemplate('edit')"><i class="icon-big-tick"></i>تحديث</button>
						<!--<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>-->
                        <span class="or_cancel"><a onclick="closePopup();">إلغاء</a></span>
					</span>
				</td>
			...
			<center><div id="project_temp_err" class="fnt_clr_rd" style="display:block;"></div></center>
				<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab" style="width:100%">
					...
					<td class="btn_align">
						...
						<span id="prj_btn">
							<button class="btn btn_blue" type="button" onclick="createTemplate()"><i class="icon-big-tick"></i>إنشاء</button>
							<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>
						</span>
					</td>
					</tr>
								...
								<tr>
									...
									<td class="btn_align">
										...
										<span id="prj_btn_task_edit">
											<button class="btn btn_blue" name="submit_template_edit" value="1" type="submit"><i class="icon-big-tick"></i>تحديث</button>
											<button class="btn btn_grey" type="button" onclick="closePopupEdit();"><i class="icon-big-cross"></i>إلغاء</button>
										</span>
									</td>
								</tr>
							</table>
				...
				<table cellpadding="0" cellspacing="0" class="col-lg-12 new_auto_tab" style="width:100%">
					...
					<td class="btn_align">
						...
						<span id="prj_btn_edit">
							<button class="btn btn_blue" type="button" onclick="save_edit_template()"><i class="icon-big-tick"></i>تحديث</button>
							<button class="btn btn_grey" type="button" onclick="closePopup();"><i class="icon-big-cross"></i>إلغاء</button>
						</span>
					</td>
					</tr>
	...
	<div class="popup_form1">
	    ...
	    <div id="inner_task">
			<div class="task_slide_in">
				...
				<span id="taskheading">إنشاء</span> مهمة
				</span>
			</div>
			<div class="cb"></div>
							...
							<?php if(count($getallproj) == 0){ ?>
								<div id="projUpdateTop">
									<?php if(SES_TYPE <=2){
										...
										<span class="no_project_assgn">--لا يوجد--</span>
									<?php }  ?>
								</div>
								<?php } ?>
								<?php
...
<!--											<div class="find_prj_ie">Find a Project</div>-->
				...
				<tr>
					<td colspan="2">
						...
						<div class="col-lg-9 fl rht-con">
							<input class="form-control" type="text" placeholder="أضف المهمة هنا ثم إضغط على الرجوع" id="CS_title" maxlength='240' onblur='blur_txt();checkAllProj();' onfocus='focus_txt()' onkeydown='return onEnterPostCase(event)' onkeyup='checktitle_value();' style="font-size:15px;"/>
						</div>
					</td>
				</tr>
				<tr>
						...
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td align="left">
									...
									$thursday = date('Y-m-d',strtotime($userDate."next Thursday"));
									$sunday = date('Y-m-d',strtotime($userDate."next Sunday"));
									...
									<div class="fl lbl-m-wid" style="padding-top:17px">Due Date:</div>
										<div class="col-lg-9 fl rht-con">	
											...
											<div class="more_opt" id="more_opt3" >
												<ul>
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;لا تاريخ استحقاق<span class="value">لا تاريخ استحقاق</span></a></li>
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;اليوم<span class="value"><?php echo date('M j, D',strtotime($userDate));?></span> </a></li>
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;الأحد القادم <span class="value"><?php echo date('M j, D',strtotime($sunday));?></span></a></li>
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;غداً<span class="value"><?php echo date('M j, D',strtotime($tomorrow));?></span></a></li>
													<li><a href="javascript:jsVoid()">&nbsp;&nbsp;هذا الخميس<span class="value"><?php echo date('M j, D',strtotime($thursday));?></span></a></li>
													<li style="color:#808080; padding-left:10px;">
														<input type="hidden" id="due_date" title="Custom Date" style="min-width:30px;"/>&nbsp;<span style="position:relative;">تحديد التاريخ</span>
													</li>
												</ul>
											</div>
										</div>
									...
									<table cellpadding="0" cellspacing="0">
										<tr>
											...
											<td align="left">
                                                ...
                                                <div class="fl pri_type">منخفض</div>
                                                ...
                                                <div class="fl pri_type">متوسط</div>
                                                ...
                                                <div class="fl pri_type">عالي</div>
											</td>
										</tr>
									</table>
								</td>
				...
				<tr>
					<td colspan="2" align="left">
						...
						<div class="col-lg-9 fl rht-con rht_bg" style="padding-left:4px; padding-bottom:0">
							...
							<div class="fr less_toggle tasktoogle" id="less_tsk_opt_div" style="display:none;position: relative;float:left"><a href="javascript:jsVoid();" onclick="closecase();"  style="text-decoration:none">اقل<b class="caret"></b></a></div>
			...
			<div class="col-lg-12 task_slide_in btm_block">
				<div style="float:left;width:255px;">
					...
					<button class="btn btn_blue" <?php if(count($getallproj) == 0) { ?>disabled="disabled"<?php }?> type="submit" onclick ="return submitAddNewCase('Post',0,'','','',1,'');"><i class="icon-big-tick"></i><span id="ctask_btn">أرسل</span></button>
					<!--<button class="btn btn_grey" type="reset" id="rset" onclick="crt_popup_close();"><i class="icon-big-cross"></i>إلغاء</button>-->
                    <span class="or_cancel">
                    <a id="rset" onclick="crt_popup_close();">إلغاء</a>
                    </span>
					</span>
