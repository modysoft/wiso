	...
	<% } %>
		...
		<tr class="tr_all" id="curRow<%= fileId %>">
			...
			<div class="dropdown fl">
				...
				<li><a onclick="removeFileFrmFiles(<%= fileId %>)" data-name="<%= fileName %>" id="file_remove_<%= fileId %>" href="javascript:void(0);"><div class="act_icon act_del_task fl" title="Remove"></div>إزالة</a></li>
			    </ul>
			</div>
		    </td>
