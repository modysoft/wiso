	...
	<?php if(PAGE_NAME != "help" && PAGE_NAME != "tour" && PAGE_NAME != "customer_support") { ?>
		  <ul class="nav navbar-nav side-nav">
			...
			<li class="new_task_li">
				<button class="btn new_task" type="button" onclick="creatask();"><i class="icon-new-task"></i>إنشاء المهمة</button>
			</li>
                        <?php }else {?>
                        <li class="new_task_li">
				<button class="btn new_task" type="button" onclick="alert('Please create a Project to add Task under that Project');" ><i class="icon-new-task"></i>إنشاء المهمة</button>
			</li>
			<?php } }?>
			
			<li class="allmenutab <?php if(CONTROLLER == "easycases" && (PAGE_NAME == "mydashboard")) { echo 'active'; } ?>"><a href="<?php echo HTTP_ROOT.'mydashboard';?>"><i class="menu_sprite_ico menu_sprite_ico_dashboard"></i> لوحة المتابعة</a></li>
			
			
			<li class="menu-cases"><a href="<?php echo HTTP_ROOT.'dashboard#tasks';?>" onclick="checkHashLoad('tasks')"><i class="menu_sprite_ico menu_sprite_ico_task"></i> المهام<span class="notify" id="taskCnt" style="display: none;" rel="tooltip" title=""></span></a></li>
			<li class="menu-files"><a href="<?php echo HTTP_ROOT.'dashboard#files';?>" onclick="checkHashLoad('files')"><i class="menu_sprite_ico menu_sprite_ico_file"></i> الملفات<span class="notify" id="fileCnt" style="display: none;" rel="tooltip" title=""></span></a></li>
			
			<li class="menu-milestone <?php if(CONTROLLER == "milestones" && (PAGE_NAME == "milestone")) { echo 'active'; }?>"><a href="<?php echo HTTP_ROOT.'dashboard#milestonelist';?>" onclick="checkHashLoad('milestonelist')"><i class="menu_sprite_ico menu_sprite_ico_milestone"></i> معالم المشروع</a></li>
			
			
			
            <li class="allmenutab <?php if(CONTROLLER == "projects" && (PAGE_NAME == "manage")) { echo 'active'; } ?>"><a href="<?php echo HTTP_ROOT.'projects/manage';?>"><i class="menu_sprite_ico menu_sprite_ico_proj"></i> المشاريع</a></li>
			<?php
			if(SES_TYPE == 1 || SES_TYPE == 2)
			{
			?>
				<li class="allmenutab <?php if(CONTROLLER == "users" && (PAGE_NAME == "manage")) { echo 'active'; } ?>"><a href="<?php echo HTTP_ROOT.'users/manage';?>"><i class="menu_sprite_ico menu_sprite_ico_usr"></i> المستخدمين</a></li>
				<li class="allmenutab <?php if(CONTROLLER == "projects" && (PAGE_NAME == "groupupdatealerts")) { echo 'active'; } ?>"><a href="<?php echo HTTP_ROOT.'reminder-settings';?>"><i class="menu_sprite_ico menu_sprite_ico_gupd"></i> المتابعة اليومية</a></li>
			<?php
			}
			?>
			

			<li <?php if((CONTROLLER == "archives" && (PAGE_NAME == "listall")) || CONTROLLER == "templates") { echo 'style="display:block;"'; }?><?php if(CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report")) { echo "class='active more_menu_li'"; echo ' style="display:block;"'; } else { if(SES_TYPE != 3) { echo " class='more_menu_li'"; } } ?>><a href="<?php echo HTTP_ROOT.'task-report/';?>"><i class="menu_sprite_ico menu_sprite_ico_anltc"></i> التحليل</a></li>
			
			<li <?php if((CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report")) || CONTROLLER == "templates") { echo 'style="display:block;"'; }?> <?php if(CONTROLLER == "archives" && (PAGE_NAME == "listall")) { echo "class='active more_menu_li'"; echo ' style="display:block;"'; } else { if(SES_TYPE != 3) { echo " class='more_menu_li'"; } } ?>><a href="<?php echo HTTP_ROOT.'archives/listall#caselist';?>"><i class="menu_sprite_ico menu_sprite_ico_arch"></i> الأرشفة</a></li>
			...
			<li <?php if((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) { echo "class='close'"; }else{ echo 'class=""'; } ?>>
				<a href="javascript:void(0);" class="more_in_menu">
					<?php if((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) { echo "أقل"; }else{echo "أكثر";} ?>
				</a>
...
<!--			<li class="dropdown cust_rec" id="customFil" <?php if(((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) && (SES_TYPE == 1 || SES_TYPE == 2)) { echo ' style="display:none;"'; } ?>>
			...
			<li class="dropdown cust_rec" id="recentCases" <?php if(((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) && (SES_TYPE == 1 || SES_TYPE == 2)) { echo 'style="display:none;"'; } ?>>
			  <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" onclick="openAjaxRecentCase();"><i class="menu_sprite_ico menu_sprite_ico_rec"></i> شوهدت مؤخرا
			  <b class="menu_more_arr"></b></a>
	  ...
	  <ul class="nav navbar-nav navbar-left navbar-user" <?php if(PAGE_NAME == "help") { ?>style="margin-left:0px;"<?php } ?>>
        ...
        <li class="dropdown user-dropdown user_gt">
        	<a href="<?php echo HTTP_ROOT.'getting_started';?>" title="إبـدء من هنـــا">
        	<div class="fl get_icon"></div>
            <span class="ipad_txt">إبـدء من هنـــا</span></a>
        </li>         
	  </ul>
			...
			<form class="navbar-form navbar-left top_search" role="search">
			  <div id="srch_load1" class="fl lod-src-itm"> 
				...
				<input type="hidden" value="<?php echo $srch_text; ?>" id="hid_srch_text" />
				  ...
				  <?php } ?>
				  <input type="text" class="form-control search_top" name="case_search" id="case_search" autocomplete="off" onClick="sch_slide();" onkeypress="onKeyPress(event,'case_search');" onkeydown="return goForSearch(event,'');" placeholder="البحث في المهام" />
				</div>
                    ...
                    <div class="sett_div sett_pop_div">
                        <div>
                            <ul class="new_sub_menu">
                                <li><a href="javascript:void(0);" onClick="newProject()"><i class="menu_os_ico menu_os_ico_proj"></i>المشروع</a></li>
                                <li><a href="javascript:void(0);" onClick="newUser()"><i class="menu_os_ico menu_os_ico_user"></i>المستخدم</a></li>
                                <?php if($is_active_proj){?>
                                <li><a href="javascript:void(0);" onClick="creatask()"><i class="menu_os_ico menu_os_ico_task"></i>المهمة</a></li>
                                <li><a href="javascript:void(0);" onClick="addEditMilestone(this)"><i class="menu_os_ico menu_os_ico_mlst"></i>المعلم</a></li>
                                <?php }?>
		  ...
		  <ul class="dropdown-menu">
			<li>
				<ul class="user_sett_info">
					<li class="settings_hd"><span title="<?php echo CMP_SITE; ?>"><?php echo $this->Format->shortLength(CMP_SITE,25); ?> هذا الحساب بإدارة </span></li>
			...
			<li>
				<div class="sett_div">
					<div>
						<ul>
							<li class="settings_hd">إعدادات شخصية</li>
							<li><a href="<?php echo HTTP_ROOT.'users/profile';?>">ملفي</a></li>
							<li><a href="<?php echo HTTP_ROOT.'users/email_notifications';?>">التنبيهات</a></li>
							<li><a href="<?php echo HTTP_ROOT.'users/email_reports';?>">التقارير البريدية</a></li>
							<li style="margin-bottom:5px;border-bottom:none;box-shadow: none;"><a href="<?php echo HTTP_APP;?>users/logout" class="sign_out">خــروج</a></li>
						</ul>	
					</div>
					<?php
					if(SES_TYPE == 1 || SES_TYPE == 2)
					...
					<div>
						<ul>
						    <li class="settings_hd">إعدادات المؤسسة</li>
							<li><a href="<?php echo HTTP_ROOT.'my-company';?>">إدارتي</a></li>
							<li><a href="<?php echo HTTP_ROOT.'reminder-settings';?>">المتابعة اليومية</a></li>
							<li><a href="<?php echo HTTP_ROOT.'import-export';?>">إدخال وإستخراج البيانات</a></li>
							<li><a href="<?php echo HTTP_ROOT.'task-type';?>">نوع المهمة</a></li>
						</ul>	
					</div>
					<?php
					}
...
<!--<div class="fr task_section case-filter-menu" data-toggle="dropdown" title="Task Filter" onclick="openfilter_popup(0);">
	<button type="button" class="btn tsk-menu-filter-btn" >
		...
		<ul class="dropdown-menu" id="dropdown_menu_all_filters">
			...
			<li>
				<a href="javascript:jsVoid();" title="Time" data-toggle="dropdown" onclick="allfiltervalue('date');"> الوقت</a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Due Date" data-toggle="dropdown" onclick="allfiltervalue('duedate');"> تاريخ الإستحقاق</a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Status" data-toggle="dropdown" onclick="allfiltervalue('status');">الحالة</a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Types" data-toggle="dropdown" onclick="allfiltervalue('types');">الأنواع</a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Priority" data-toggle="dropdown" onclick="allfiltervalue('priority');">الأهمية</a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Users" data-toggle="dropdown" onclick="allfiltervalue('users');">أنشئها  </a>
			...
			<li>
				<a href="javascript:jsVoid();" title="Assign To" data-toggle="dropdown" onclick="allfiltervalue('assignto');">عيين</a>
...
<!--<div class="dashborad-view-type" >
	<a href="<?php echo HTTP_ROOT.'dashboard#tasks';?>" onclick="checkHashLoad('tasks')"><div id="lview_btn" class="fl btn gry_btn kan30" rel="tooltip" title="رؤية كجدول"><i class="icon-list-view"></i></div></a>
	<a href="<?php echo HTTP_ROOT.'dashboard#kanban';?>" onclick="checkHashLoad('kanban')"><div id="kbview_btn" class="fl btn gry_btn kan30" style="border-radius:0 3px 3px 0" rel="tooltip" title="رؤية كانبان"><i class="icon-kanv-view"></i></div></a>
	<div class="cb"></div>
</div>-->
<?php } } ?>
