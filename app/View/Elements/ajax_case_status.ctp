...
<div class="fl status cls" id="widget_close" style="padding-left:8px;">
	...
	<% } %>	
        ...
        <span class="num3"> <%= cls %>/<%= al %></span>&nbsp;<%= fill %> مغلقـة
    </a>
    </div>
	<?php
            ...
            <div class="popup_con_menu" align="left" style="left:-1px; min-width:50px;padding: 2px 8px;">
                <div align="left">
                    ...
                    <div  id="widget_close1" style="<%= case_wid1 %>">
                        <a href="javascript:void(0);" onclick="hideCloseWidget(<%= '\'widget_close\'' %>);">مغلقة</a>
                    </div>
    
    
                    <div  id="widget_new1" style="<%= case_new1 %>">
                        <a href="javascript:void(0);"  onclick="hideCloseWidget(<%= '\'widget_new\'' %>);" style="min-weight:10px;">جديدة</a>
                    </div>   
    
                    <div id="widget_open1" style="<%= case_open1 %>">
                        <a href="javascript:void(0);" onclick="hideCloseWidget(<%= '\'widget_open\'' %>);">متقدمة</a>
                    </div>
    
                    <div id="widget_start1" style="<%= case_start1 %>">
                        <a href="javascript:void(0);"  onclick="hideCloseWidget(<%= '\'widget_start\'' %>);" style="min-weight:10px;">بدأت</a>
                    </div>
    
                    <div  id="widget_resolve1" style="<%= case_resolve1 %>">
                        <a href="javascript:void(0);" onclick="hideCloseWidget(<%= '\'widget_resolve\'' %>);" style="min-weight:10px;">منتهية</a>
                    </div>
