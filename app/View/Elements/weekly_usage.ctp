							...
							<div>
								...
								<div style="float:left">
									<div id="tupdate_main" class="week_rpt_div" style="border-top:1px solid #696969;border-left:4px solid #FFF">
										...
										<div style="clear:both"></div>
										<div style="color:#666666;margin-top:5px;font-weight:bold">المهام المحدثة</div>
										<div style="clear:both"></div>
									<?php if($progress_flag){?>
										<div id="task_update">	
											<span style="font-size: 11px;">Loading...</span>
							...
							<div>
								<div style="float:left">
									<div id="tclosed_main" class="week_rpt_div" style="border-top:1px solid #696969;">
										...
										<div style="clear:both"></div>
										<div style="color:#666666;margin-top:5px;font-weight:bold">المهام المغلقة</div>
										<div style="clear:both"></div>
								<?php if($progress_flag){?>
...
function PrintDiv() {    
	...
	popupWin.document.write('<html><title>Weekly Usage Report <?php echo date("D, M d",  (strtotime($dateCurnt)-($days_diff*24*60*60)))."&nbsp;-&nbsp;".date("D, M d",strtotime($dateCurnt));?> </title><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
