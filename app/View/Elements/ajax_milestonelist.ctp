		...
		for(var caseKey in caseAll){
						...
						<ul class="dropdown-menu sett_dropdown-caret">
							<li class="pop_arrow_new"></li>
							 ...
							 <li  onClick="creatask(<%= getdata.Easycase.Mid %>)" >
								<a href="javascript:void(0);" class="mnsm">
									...
									<div class="fl">إنشاء مهمة جديدة</div>
									<div class="cb"></div>
								</a>
							</li>
								...
								<a href="javascript:void(0);" class="mnsm">
									...
									<div class="fl mntxt">إضافة مهمة</div>
									<div class="cb"></div>
								</a>
							</li>
							...
							<li onClick="delMilestone(<%= '\'\',\'' + milestonetitle + '\'' %>,<%= '\'' + getdata.Easycase.Muinq_id + '\'' %>);" class="makeHover" >
								<a href="javascript:void(0);" >
									...
									<div class="fl deltmntxt">حذف</div>
									<div class="cb"></div>
								</a>
							</li>
							 ...
							 <% if(isActive!=0){ %>
								<li onclick="milestoneArchive(<%= '\'\',\'' + getdata.Easycase.Muinq_id + '\'' %>, <%= '\'' + milestonetitle + '\'' %>);"  >
									<a href="javascript:jsVoid();">
										...
										<div class="fl cmplmntxt">منجز</div>
										<div class="cb"></div>
									</a>
								</li>
							<%  }else{ %>
								<li onclick="milestoneRestore(<%= '\'\',\'' + getdata.Easycase.Muinq_id + '\'' %>, <%= '\'' + milestonetitle + '\'' %>);"  >
									<a href="javascript:jsVoid();">
										<div class="ct_icon mt_completed fl"></div>
										<div class="fl cmplmntxt">استعادة</div>
										<div class="cb"></div>
									</a>
								</li>
							<%  } %>
			...
			<% 		} else { %>
						...
						<% } else { %>
								<font color="green">
						<% 		if(days > 1) { %>
									(أعمال قادمة خلال <%= days %> أيام)
						<% 		} else { %>
									(أعمال قادمة خلال <%= days %> يوم)
						<% 		} %>
								</font>
						<% }
						} }%>
					...
					<div class="cb"></div>
					<div class=" fl imprv_bar col-lg-8" title="<%= getdata.Easycase.totalClosedCs + ' out of ' + getdata.Easycase.totalCs + ' المهام التي أغلقت' %>" rel="tooltip">
			...
			<div>
				...
				<ul class="dropdown-menu sett_dropdown-caret">
					...
					<li data-prjid="<%= projId %>" data-caseid="<%= caseAutoId %>" data-caseno="<%= caseNo %>" onclick="mvtoProject(<%= '\'' + count + '\'' %>,this)" id="mv_prj<%= caseAutoId %>" style=" ">
					    <a href="javascript:void(0);"><div class="act_icon pro_mov fl" title="Move to Project"></div>إنقا الى مشروع</a>
					</li>
					<% } 
					if((caseLegend == 1 || caseLegend == 2 || caseLegend == 4) && caseTypeId!= 10) { caseFlag=2; }
					if(getdata.Easycase.isactive == 1){ %>
					...
					<div class="dropdown fl">
						...
						<ul class="dropdown-menu sett_dropdown-caret" style="min-width:166px;">
							...
							<li  onClick="creatask(<%= mdtls.id %>)" >
								<a href="javascript:void(0);">
								<div class="ct_icon act_create_task fl"></div>
									<div class="fl mntxt" style="margin-left:-12px">إنشاء مهمة جديدة</div>
								</a>                                                        
							</li>
							...
							<li onclick="addEditMilestone(<%= '\'\',\'' + mdtls.uinq_id + '\'' %>,<%= '\'' + mdtls.id + '\'' %>,<%= '\'' + milestonetitle + '\',1' %>)" class="makeHover">
								<a href="javascript:void(0)"><div class="ct_icon act_edit_task fl"></div><div class="fl">تعديل</div></a>
							</li>
                                                        <%  } %>
							<li onClick="delMilestone(<%= '\'\',\'' + milestonetitle + '\'' %>,<%= '\'' + mdtls.uinq_id + '\'' %>);" class="makeHover" >
								<a href="javascript:void(0);" ><div class="act_icon act_del_task fl"></div><div class="fl mntxt" style="margin-left:-6px">حذف</div></a>
							</li>
                                                         <% if(isActive!=0){ %>
							<li onclick="milestoneArchive(<%= '\'\',\'' + mdtls.uinq_id + '\'' %>, <%= '\'' + milestonetitle + '\'' %>);"  >
								<a href="javascript:jsVoid();"><div class="ct_icon mt_completed fl"></div> <div class="fl mntxt" style="margin-left:-7px">إكمال</div></a>
							</li>
							<%  }else{ %>
							<li onclick="milestoneRestore(<%= '\'\',\'' + mdtls.uinq_id + '\'' %>, <%= '\'' + milestonetitle + '\'' %>);"  >
								<a href="javascript:jsVoid();"><div class="ct_icon mt_completed fl"></div><div class="fl mntxt">إستعادة</div></a>
							</li>
							<%  } %>
						</ul>
					</div>
