				...
				<tr>
					...
					<td colspan="2">
						<div id="but" align="left" style="display:none;"  class="blue small">
							<span id="savspn">
								<button type="button" value="Post" name="data" style="margin-left:3px;margin:5px 0px;" class="" onclick="postcasedata('loader_id','but');">Save</button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="<?php echo HTTP_ROOT; ?>dashboard">إلغاء</a>
							</span>
