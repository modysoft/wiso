	...
	<tr>
        ...
        <div id="tablewrap" style="width:100% !important; max-width:600px !important; text-align:center; margin:0 auto;">
            ...
            <?php echo $expName;?>                        ،السلام عليكم
								...
								{
								?>
									<p>  لقد تلقيت هذه الدعوة من  <a href="mailto:<?php echo $fromEmail; ?>"><?php echo $fromName; ?></a> ،للانضمام لفريق مشروع نجـاح في إدارة التخطيط والمتابعة</p>
									<p> .الرجاء النقر هنا في الأسفل لقبول الدعوة والبدء بالأعمال مع أطيب التمنيات بالنجــــاح </p>
									
									<a style="font-weight:bold; text-decoration:none;" href="<?php echo HTTP_ROOT.'users/invitation/'.$qstr;?>" target='_blank'><div style="display:block; max-width:100% !important; width:auto !important;margin:auto; height:auto !important;background-color:#0EA426;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;border-radius:10px;color:#ffffff;font-size:16px;text-align:center"> <?php echo $company_name; ?> إبدء بإستعمال نظام المهام   </div></a>
									
								<?php
								}
								else {
								?>
									<p><a href="mailto:<?php echo $fromEmail; ?>"><?php echo $fromName; ?></a> .قد قام بإضافتك الى نظام المهام، الخاص بإدارة التخطيط والمتابعة</p>
									<p>الرجاء النقر هنا في الأسفل للبدء .</p>
									
									<a style="font-weight:bold; text-decoration:none;" href="<?php echo HTTP_ROOT.'users/invitation/'.$qstr;?>" target='_blank'><div style="display:block; max-width:100% !important; width:auto !important;margin:auto; height:auto !important;background-color:#0EA426;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;border-radius:10px;color:#ffffff;font-size:16px;text-align:center">إبدء بإستعمال نظام المهام </div></a>
								<?php
								}
								?>
								...
								<p>إذا كان لديك إي استفسار فبالإمكان التوجه الى مستشار إدارة المشاريع للإستيضاح إو التوجه لمسؤولك المباشر </p>
								
								<br/>
								
								<p>،مع طيب التحية<br/>
								إدارة التخطيط والمتابـــعة</p>
                            </td>
                        </tr>
                   </table>
                        ...
                        <tr>
                            <td width="100%" bgcolor="#ffffff" style="text-align:center;">
                            	<p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; margin-top:0; padding:0; font-weight:normal;padding-top:5px;">
									...
									?>
										نظام المهام - إدارة التخطيط والمتابعة
									<?php
									}
									?>
                                </p>
...
<?php /*?><table style="padding-top:20px;margin:0 auto;text-align:left;width:100%">
  <tbody>
	...
	<div style="color:#000;font-family:Arial;font-size:14px;line-height:1.8em;text-align:left;padding-top: 10px;">
		<p style="display:block;margin:0 0 17px">،السلام عليكم <?php echo $expName;?></p>
		<p>
			<?php echo $invitationMsg;?>
		</p>
		<p>
			<div>الرجاء النقر هنا في الإسفل لتأكيد المشاركة.</div>
