										...
										<div class="popup_link_case_proj_parent" style="position:relative;z-index:0;" align="left">
											...
											<div class="popup_option" id="popup_option" style="display:none;position:absolute;left:-22px;">
												...
												<div class="popup_con_menu" align="left" style="left:-1px; min-width:50px;padding: 2px 8px">
													<div align="left">    
														<div>
															<a href="javascript:void(0);" onclick="caseall();open_pop(this)" style="font-size:13px;font-weight:normal;">الكل</a>
														</div>
										
										
														<div>
															<a href="javascript:void(0);" onclick="casenone();open_pop(this)" style="font-size:13px;font-weight:normal;">لا يوجد</a>
														</div>
										
										
														<div id="restore">
															<a href="javascript:void(0);" onclick="milestonerestoreall();" style="font-size:13px;font-weight:normal;">إستعادة</a>
														</div>
										
														<div id="remove">
															<a href="javascript:void(0);" onclick="removeallmilestone();" style="font-size:13px;font-weight:normal;">إزالة</a>
														</div>
													</div>
												</div>
											</div>
			...
			?>
				...
				<tr>
					<td colspan="7" align="center">
						<div style="width:100%;text-align:center;font-size:13px;color:#666666;list-style:none;margin:10px;">لا معالم في المشروع مؤرشفة</div>
					</td>
				</tr>
				<?php
					}
