          ...
          <td>
               <div id="active_div" class="ui-tabs" style="display:block">
                    <ul class="ui-tabs-nav" id="ui-tabs-nav">
                         <li style="margin-left:-15px;" id = "activeli" <?php if($projtype == '') { ?>class="class_active" <?php }?>><a id="active"  href="<?php echo HTTP_ROOT."projects/".PAGE_NAME; ?>" >نشط</a></li>
                         <li id = "completeli" <?php if($projtype == 'disabled') { ?>class="class_active" <?php }?>><a id="complete"  href="<?php echo HTTP_ROOT."projects/".PAGE_NAME."/disabled"; ?>" >غير نشط</a></li>
                    </ul>
				</div>
							...
							<tr>
								...
								<?php
									...
									<td style="padding:0 4px">
										...
										if($totCase == 0) {
										?>
											<a href="javascript:void(0);" onClick="setprojectAction('delete','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover"><div class="act_del" style="margin-left:3px;" rel=tooltip  title="حذف"></div></a>
											
										<?php
										}
										else {
										?>
											<a href="javascript:void(0);" onClick="setprojectAction('activate','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']; ?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover"><div class="act_dis" style="margin-left:3px;" rel=tooltip  title="نشط"></div></a>
										<?php
										}
										?>
									</td>
	...
	<tr>
		<td style="padding-left:10px;" valign="middle" class="ms_hd">
			...
			<div style="float:right;padding-right:13px;">
				<button class="green" id="inviteusr" onclick="newUser('menuid','loaderid','add_user');" style="margin-top:1px;height: 27px;width: 107px;padding:4px 12px;text-align: right;"><div class="icon_invt"></div>دعوة مستخدم</button>
		...
		<td align="center">
			...
			<td valign="middle" style="width:500px" align="center" class="nwa">
				<span id="confirmbtn" style="display:block;">
					<button class="pop_btn" id="confirmusercls" style="margin-left:3px;" value="Confirm" type="button" onclick="assignuser(this)">إضافة</button>
					 <button class="pop_btn" id="confirmuserbut" style="margin-left:3px;" value="Confirm" type="button" onclick="assignuser(this)">إضافة و متابعة</button>
