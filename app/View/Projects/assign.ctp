												...
												<table cellpadding="0" cellspacing="0" border="0">
													...
													<tr height="30px">
														<td align="center" class="text">
															Select:
															<a href='#' onclick='return $.dds.selectAll("list_1");' class="footerLnk" style="text-decoration:underline">الكل</a>&nbsp;
															<a href='#' onclick='return $.dds.selectNone("list_1");' class="footerLnk" style="text-decoration:underline">لا يوجد</a>
														</td>
													</tr>
											...
											<td align="left" valign="top">
												<table cellpadding="0" cellspacing="0" border="0">
													...
													<tr height="30px">
														<td align="center" class="text">
															Select: 
															<a href='#' onclick='return $.dds.selectAll("list_2");' class="footerLnk" style="text-decoration:underline">الكل</a>
															<a href='#' onclick='return $.dds.selectNone("list_2");' class="footerLnk" style="text-decoration:underline">لا يوجد</a>
														</td>
													</tr>
													<tr>
											...
											<td align="right" valign="top">
												<table cellpadding="0" cellspacing="0" border="0">
													...
													<tr height="30px">
														<td align="center" class="text">
															Select:
															<a href='#' onclick='return $.dds.selectAll("list_3");' class="footerLnk" style="text-decoration:underline">الكل</a>&nbsp;
															<a href='#' onclick='return $.dds.selectNone("list_3");' class="footerLnk" style="text-decoration:underline">لا يوجد</a>
														</td>
													</tr>
													<tr>
											...
											<td align="left" valign="top">
												<table cellpadding="0" cellspacing="0" border="0">
													...
													<tr height="30px">
														<td align="center" class="text">
															Select: 
															<a href='#' onclick='return $.dds.selectAll("list_4");' class="footerLnk" style="text-decoration:underline">الكل</a>
															<a href='#' onclick='return $.dds.selectNone("list_4");' class="footerLnk" style="text-decoration:underline">لا يوجد</a>
														</td>
													</tr>
													<tr>
														<td align="center" style="width:320px;">
							...
							<tr>
								<td class="label-normal" align="center">
									<div style="position:relative;top:-8px;">
										...
										or
										<a href="<?php echo HTTP_ROOT; ?>dashboard">إلغاء</a>
									</div>
								</td>
							</tr>
						</table>
