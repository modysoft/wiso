...
<div class="close_oly">
    <div class="close_txt">
        <div class="fl oly_wc"> أهلا بك <img src="img/images/logo_outer_sml.png" style="margin-top: -4px; margin-left: 4px;" /> !</div>
        <div class="oly_text fr">
            <div>خذ بعض الوقت لتدوين الأعمال الرئيسية</div>
...
<div class="main_overlay">
    ...
    <div class="oly_usr_sett">
        ...
        <div class="oly_usr_sett_txt">الخاص، الشركة وإعدادات الحساب</div>
    </div>
    <div class="oly_lcnt_mdiv">
        <div class="oly_container oly_cont_mt1">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">أعمال للإنجاز، ملخص والإحصاءات</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt2">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">البحث، تصفية، ترتيب المهام المجموعة</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt3">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">قائمة الملفات المرفقة بالمهام</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt4">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">إنشاء معلم مشروع، أضف مهمة لهذاالمعلم ثم حدد تاريخ التسليم /div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt5">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">إنشاء وإدارة المشاريع. تعيين المشاريع لفريق</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt6">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">إضافة أعضاء الفريق وإدارتهم. إضافة المستخدمين إلى المشاريع.</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt7">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt">فقط جدول ذلك للحصول على تحديث التقدم اليومي في فريقك</div>
            <div class="cb"></div>
        </div>
    </div>
</div>
