...
<table cellspacing="0" cellpadding="0" width="560px" class="div_pop" align="center" style="margin:40px auto;">
	...
	<td align="left" style="padding-top:10px">
	    <div style="display: none;padding-bottom: 7px;" id="cancel_daily_update"><a style="color: red;" onclick="cancel_daily_update();" href="javascript:jsVoid();">إلغاء تذكير التقدم اليومي</a></div>
		...
		<span id="spn_btn"><button type="button" id="daily_btn" style="margin-top:5px;width:75px" class="pop_btn" onclick="return validateDailyMail();">حفظ</button></span>
		<span class="fnt_opensans">&nbsp;&nbsp;or&nbsp;&nbsp;
		<a onclick="cover_close('cover','dailyupd_popup');" href="javascript:jsVoid();">إلغاء</a></span>
	    </span>
