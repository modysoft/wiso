...
<div class="impexp_div" style="border:0;margin-top:0;margin-bottom:5px;">
    <div style="width:600px;margin:25px auto 5px;border:1px solid #BCE8F1;text-align:left;background:#D9EDF7;color:#31708F;font-size:13px;padding:5px 5px" class="fl">
      هنالك  ١٢ نوع من أنواع المهام الافتراضية المدرجة والمهام المرتبطة بها، يمكنك إزالة أي منها عن طريق إلغاء تحديد مربع الاختيار وحفظ التغييرات<br/>إنقر على "<b>+ نوع مهمة جديد</b>" وأضف أنواع المهمات المناسبة لك
    </div>
    <div class="fr"><button class="btn btn_blue" onclick="addNewTaskType();" style="padding: 5px;margin-right: 3px !important;margin-top:60px">+ أضف نوع مهمة جديد</button></div>
    <div class="cb"></div>
</div>
...
<div class="impexp_div" style="border:none">
    ...
    <br/><br/>
   	<button onclick="newProject();" type="button" class="btn btn_blue">إنشاء مشروع</button>
