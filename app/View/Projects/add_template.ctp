							...
							<td valign="top">
								...
								<td></td>
									...
									<tr height="40px">
										...
										<span id="subprof1">
										<button  value="Save" name="submit_template" id="submit_template" class="pop_btn">حفظ</button>
										<span class="fnt_opensans">&nbsp;&nbsp;or&nbsp;&nbsp;
										<a href="<?php echo $referer; ?>">إلغاء</a></span>
									</span>
						  ...
						  <table cellpadding="4" cellspacing="4" border="0" align="center">
							...
							<tr>
								...
								<td align="left" style="padding-top:5px;">
								  ...
								  <span id="btn">
									  <button type="button" value="Create Template" name="crtTempmod" style="margin-left:3px;" id="add_new_template" class="pop_btn" onclick="template_module_add()">Create</button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="javascript:void(0);" onClick="cover_close('cover','add_temp_mod');unsel_temp();">إلغاء</a>
								  </span>
							  </td>
							  </tr>
						  </table>
