...
<div id="recent_view1">
        ...
        <!--<li style="padding-top:0px; padding-bottom:0px;"><a href="#" title="" class="recent show_recent" style="margin-top:0px; font-size:15px; min-height:24px">شوهدت مؤخرا</a></li>-->
