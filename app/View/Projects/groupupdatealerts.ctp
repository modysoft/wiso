 ...
 echo $this->Form->create('Project', array('name' => 'dailyUpdateForm','id' => 'dailyUpdateForm','url'=>"/projects/dailyUpdate")); ?>
    <table cellspacing="0" cellpadding="0" class="col-lg-5 dailyTbl grp_tbl" style="text-align:left; width:100%;">
    	...
    	<tr>
			<th></th>
			<td class="btn_align">
				<div style="display: none;padding: 0 0 25px;" id="cancel_daily_update"><a style="color: red;text-decoration: underline;" onclick="cancel_daily_update();" href="javascript:jsVoid();">إلغاء المتابعة اليومية</a></div>
				<div>
				<span id="subprof1">
					...
					<!--<button type="button" class="btn btn_grey" onclick="cancelProfile('<?php echo $referer;?>');"><i class="icon-big-cross"></i>إلغاء</button>-->
					 <span class="or_cancel">or
						<a onclick="cancelProfile('<?php echo $referer;?>');">إلغاء</a>
					</span>
				</span>
...
<div class="fl import-info-dif dl_updt">
    <div class="chk_content" style="width:100%">
        <h4 class="chk_head">هل ترغب في الحصول على تحديث التقدم اليومي من أعضاء فريقك؟ <br/> مجرد جدولة ذلك والجلوس، في نهاية اليوم سوف تحصل على البريد الإلكتروني التحديث في البريد الوارد الخاص بك.</h4>
        <ul class="chk_desc">
            <li>الحصول على التحديثات اليومية  من فرق العمل دون إزعاجهم</li>
            <li>الحصول على التقدم اليومي من الفريق الخاص بك في بريد الإلكتروني واحد</li>
            <li>  إحصل على التحديثات اليومية من فريقك أوتوماتيكياً</li>
        </ul>
