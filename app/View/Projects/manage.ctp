    ...
    <div class="tab tab_comon">
        <ul class="nav-tabs mod_wide">
            <li <?php if($projtype == '') { ?> class="active" <?php }?>>
                ...
                <div class="fl"><span id="active_proj_cnt" class="counter">(<?php echo $active_project_cnt;?>)</span>نشط</div>
                <div class="cbt"></div>
                </a>
            </li>
            <li <?php if($projtype == 'inactive') { ?> class="active" <?php }?>>
                ...
                <div class="fl"><span id="inactive_proj_cnt" class="counter">(<?php echo $inactive_project_cnt;?>)</span>غير نشط</div>
                <div class="cbt"></div>
                </a>
            </li>
            <div class="cbt"></div>
...
<div class="col-lg-12 m-left-42 prj_div">
    ...
    <div class="col-lg-4">
		<div class="col-lg-12 text-centre">
			...
			<div class="fnt_clr_rd"><?php if (@SES_TYPE ==3){ ?>لم تنشئ أي مشروع بعد.<?php } else { ?>لا يوجد مشاريع<?php } ?></div>
			</div>
		</div>
	</div>
    <?php } ?>
	...
	<div class="col-lg-4 proj_mng_div">
		<div class="col-lg-12 contain usr_mng_div <?php if($projtype == 'inactive') { ?>inactv <?php } ?>">
			...
			<?php if($projtype == '') { ?>
			    <div class="proj_mng">
				<div class="fl">
				    <a href="javascript:void(0);" class="icon-add-usr fl" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>">إضافة مستخدم</a><br />
					<span id="remove<?php echo $prjArr['Project']['id'];?>">
						<?php if(!empty($prjArr[0]['totusers'])){ ?>
							<a href="javascript:void(0);" class="icon-remove-usr" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>">حذف مستخدم</a>
						<?php } ?>
					</span>
				...
				<div class="fr">
				    <a href="javascript:void(0);" class="icon-edit-usr fl" data-prj-id="<?php echo $prjArr['Project']['uniq_id'];?>" data-prj-name="<?php echo $prj_name;?>">تعديل</a><br />
				    
				    <?php if($prjArr[0]['totalcase']) { ?>
				<a href="javascript:void(0);" class="icon-disable-usr fl disbl_prj" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>">تعطيل</a>
				<?php } else { ?>
				    <a href="javascript:void(0);" class="icon-del-prj del_prj" data-prj-id="<?php echo $prjArr['Project']['uniq_id'];?>" data-prj-name="<?php echo $prj_name;?>">حذف</a>
				<?php } ?>
				</div>
			    </div>
			<?php } else { ?>
				<div class="proj_mng">
				    <div class="fl"><a href="javascript:void(0);" class="icon-enable-prj enbl_prj" data-prj-id="<?php echo $prjArr['Project']['id'];?>" data-prj-name="<?php echo $prj_name;?>">تفعيل</a></div>
				    <div class="fr"><a href="javascript:void(0);" class="icon-del-prj del_prj" data-prj-id="<?php echo $prjArr['Project']['uniq_id'];?>" data-prj-name="<?php echo $prj_name;?>">حذف</a></div>
				    <div class="cb"></div>
				</div>
			<?php }  ?>
		    </div>
