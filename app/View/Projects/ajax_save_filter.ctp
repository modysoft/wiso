						  ...
						  <table cellpadding="10" cellspacing="10" border="0" align="center">
							  ...
							  <tr>
								  ...
								  <td align="left">
									  ...
									  <span id="btn">
										  <button type="submit" value="Create" name="crtProject" class="blue" onclick="submitfilter();">Confirm</button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="javascript:void(0);" onClick="cover_close('cover','inner_save_filter');">إلغاء</a>
									  </span>
