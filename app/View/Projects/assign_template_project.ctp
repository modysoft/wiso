				...
				<tr>
					<td align="left" style="font-weight:bold;font-size:14px;">
						...
						<div style="float:left;font-size:10px;margin-left:10px;font-size:13px;">
							<span id="subprof1">
								<button style="margin: 5px 0 0;width:121px;text-align:right" value="Show Tasks" onclick="add_cases_project()"><div class="icon_fil"></div>إدخال بيانات المهام</button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="<?php echo $referer; ?>" style="text-decoration:none;font-size:13px;font-weight:normal;">إلغاء</a>
							</span>
						</div>
