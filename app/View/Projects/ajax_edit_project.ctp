...
<?php  echo $this->Form->create('Project',array('url'=>'/projects/settings','name'=>'projsettings','enctype'=>'multipart/form-data'));  ?>
	...
	<tr>
		...
		<span id="btn" class="project_edit_button">
		    ...
		    <button type="button" value="Save" class="btn btn_blue" onclick= "return submitProject('txt_proj','txt_shortProjEdit')" id="savebtn"><i class="icon-big-tick"></i>حفظ</button>
