					...
					<div style="padding-right:2px;">
						...
						<span id="spntitlenone<%= count %>" style="display:none">
							...
							<div style="float:right;padding-right:5%;">
								<a href="javascript:void(0);" style="text-decoration:underline" onclick="updateCases('<%= count %>','<%= caseAutoId %>','<%= projId %>')">حفظ</a>
								&nbsp;or&nbsp;
								<a href="javascript:void(0);" style="text-decoration:underline" onClick="spndisplay('<%= count %>','<%= caseAutoId %>')">إلغاء</a>
							</div>
						</span>
					</div>
