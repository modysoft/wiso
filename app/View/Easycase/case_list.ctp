<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
	<tr>
		<td align="left" style="padding:2px;font-size:20px;text-shadow: 0 1px 1px #B3B3B3;font-weight: bold;text-shadow: 0 1px 1px #B3B3B3;">
			<h1 class="toplink">الأرشفة > المهام</h1>
		</td>
	</tr>
	<tr>
	<td>
		<a href="javascript:void(0)" onclick="caseall()">الكل</a>
		<a href="javascript:void(0)" onclick="casenone()">لا يوجد</a>
		<a href="javascript:void(0)" onclick="restoreall()">إستعادة</a>
		<a href="javascript:void(0)" onclick="removeall()">إزالة</a>
	</td>
	</tr>
	<tr>
		<td>
			...
			<table border="1" style="border:1px solid #CFD7DD" width="100%">
				<tr bgcolor="#CFD7DD" style="font-weight:bold;color:#333333;padding-left:5px;" height="25px"  valign="top">
					...
					<td  style="width:40px;" align="center">المهمة#</td>
					<td  style="padding-left:4px;" align="left">العنوان</td>
					<td  style="padding-left:4px;width:80px;" align="left">الحالة</td>
					<td  style="padding-left:4px;width:140px;" align="left">المشروع</td>
					<td  style="padding-left:4px;width:160px;" align="left">تاريخ الأرشفة</td>
					<td align="center" width="80px">العمل</td>
				</tr>
			<?php
				$repeatLastUid = "";
				$clas = "";
			...
			?>
				...
				<?php 
					...
					<td align="center">
						<?php echo $this->Html->link($this->Html->image("images/reply.png",array('rel' => 'tooltip','original-title' => "إنقل الى المهام",'height' => '14','width' => '14','onclick'=>'return confirm("Are you sure you want to move \''.$lis['Easycase']['title'].'\' to cases?")')), array('controller'=>'easycases','action' => 'move_list/'.$lis['Easycase']['uniq_id']) ,array('escape' => false)); ?>
						&nbsp;
						<?php echo $this->Html->link($this->Html->image("images/rem.png",array('rel' => 'tooltip','original-title' => "إزالة نهائية",'height' => '14','width' => '14','onclick'=>'return confirm("Are you sure you want to remove \''.$lis['Easycase']['title'].'\' permanently ?")')), array('controller'=>'easycases','action' => 'case_list/'.$lis['Easycase']['uniq_id']) ,array('escape' => false)); ?>
					</td>
