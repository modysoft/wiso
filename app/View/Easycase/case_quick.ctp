...
<input type="hidden" id="CS_due_date" value="<?php if(isset($taskdetails) && $taskdetails['due_date']){echo date('m/d/Y',strtotime($taskdetails['due_date']));}else{?>لا تاريخ استحقاق<?php }?>">
									...
									<div class="opt1" id="opt1">
										<a href="javascript:jsVoid()" onclick="open_more_opt('more_opt');">
											...
											<?php if(isset($taskdetails) && $taskdetails['type_id']){
												...
												<img class="flag" src="<?php echo HTTP_IMAGES.'images/types/dev.png';?>" alt="type" style="padding-top:3px;"/>&nbsp;أعمال متابعة
											<?php }?>
											</span> 
						...
						<div class="fl dropdown option-toggle p-6">
							...
							<div class="more_opt" id="more_opt3">
								<ul>
									...
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;اليوم<span class="value"><?php echo date('m/d/Y',strtotime($userDate));?></span> </a></li>
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;الأحد القادم <span class="value"><?php echo date('m/d/Y',strtotime($sunday));?></span></a></li>
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;غداً<span class="value"><?php echo date('m/d/Y',strtotime($tomorrow));?></span></a></li>
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;هذا الخميس<span class="value"><?php echo date('m/d/Y',strtotime($thursday));?></span></a></li>
			...
			<td id="task_priority_td" >
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td align="left">
							<div class="fl prio_radio y_low" onclick="check_priority(this);" ><input type="radio" name="task_priority" value="2" id="priority_low" <?php if(isset($taskdetails['priority']) && $taskdetails['priority']==2){?>checked="checked"<?php }?> />&nbsp;منخفض&nbsp;&nbsp;</div>
							<div class="fl prio_radio g_mid" onclick="check_priority(this);"><input type="radio" name="task_priority" value="1" id="priority_mid"  <?php if(!isset($taskdetails['priority'])){?>checked="checked"<?php }elseif($taskdetails['priority']==1){?>checked="checked"<?php }?>  />&nbsp;متوسط&nbsp;&nbsp;</div>
							<div class="fl prio_radio h_red" onclick="check_priority(this);"><input type="radio" name="task_priority" value="0" id="priority_high" <?php if(isset($taskdetails['priority']) && $taskdetails['priority']==0){?>checked="checked"<?php }?> />&nbsp;عالي&nbsp;&nbsp;</div>
<!--							<span id="hd2">
								<div class="fl dropdown option-toggle p-6">
