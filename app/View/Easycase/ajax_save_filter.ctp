...
<tr>
  ...
  <td align="left">  	  
	  ...
	  <div id="saveFilBtn" style="display:block;">	  
	      <button type="submit" value="Create" class="btn gry_btn btn_pop fl" onclick="submitfilter();">حفظ</button>
	      <button type="button" value="Cancel" class="btn gry_btn btn_pop fl" onClick="closePopup();">إلغاء</button>
	  </div>
