...
<!--		<i class="db-filter-icon fl"></i>
		<div class="fl ftext">الفلاتر:&nbsp;</div>-->
		<div class="fl task_section case-filter-menu " data-toggle="dropdown" title="Task Filter" onclick="openfilter_popup(0,'dropdown_menu_all_filters');">
			...
			<ul class="dropdown-menu" id="dropdown_menu_all_filters" style="position: absolute;">
				...
				<li>
					<a href="javascript:jsVoid();" title="Users" data-toggle="dropdown" onclick="allfiltervalue('users');">المنشئ </a>
				...
				<li>
					<a href="javascript:jsVoid();" title="Assign To" data-toggle="dropdown" onclick="allfiltervalue('assignto');">المعيين</a>
...
<!--				<div style="display:none;" id="savefilter_btn" class="fl"  >
				...
				<div class="fl db-filter-reset-icon" style="display:none;" id="reset_btn" title="الوضع السابق" rel="tooltip" onClick="resetAllFilters('all');"></div>
		   </div>
			...
			<button type="button" class="btn tsk-menu-sortgroup-btn flt-txt" >
					<i class="icon_groupby_img"></i>تجميع حسب<i class="icon-filter-right"></i>
			</button>
			<ul class="dropdown-menu" id="dropdown_menu_groupby_filters" style="position: absolute;">
				<li class="pop_arrow_new"></li>
<!--				<li>
					<a href="javascript:jsVoid();" title="Time" data-toggle="dropdown" onclick="groupby('crtdate');"> تاريخ الإنشاء</a>
				</li>-->
				<li>
					<a href="javascript:jsVoid();" title="Due Date" data-toggle="dropdown" onclick="groupby('duedate');"> تاريخ الإستحقاق</a>
				</li>
				<li>
					<a href="javascript:jsVoid();" title="Status" data-toggle="dropdown" onclick="groupby('status');">الحالة</a>
				</li>
				<li>
					<a href="javascript:jsVoid();" title="Priority" data-toggle="dropdown" onclick="groupby('priority');">الأهمية</a>
				</li>
				<li>
					<a href="javascript:jsVoid();" title="Priority" data-toggle="dropdown" onclick="groupby('assignto');">التعيين</a>
				</li>
			</ul>
		</div>
		...
		<button type="button" class="btn tsk-menu-sortgroup-btn flt-txt sortby_btn <?php if(isset($_COOKIE['TASKGROUPBY']) && ($_COOKIE['TASKGROUPBY']!='date')){?>disable-btn<?php }?> " onclick="openfilter_popup(0,'dropdown_menu_sortby_filters');" <?php if(isset($_COOKIE['TASKGROUPBY']) && ($_COOKIE['TASKGROUPBY']!='date')){?>disabled="disabled"<?php }?>>
				<i class="icon_sortby_img"></i>ترتيب حسب<i class="icon-filter-right"></i>
		</button>
		<ul class="dropdown-menu" id="dropdown_menu_sortby_filters" style="position: absolute;">
			<li class="pop_arrow_new"></li>
			<li>
				<a href="javascript:jsVoid();"  data-toggle="dropdown" onclick="ajaxSorting('title');">العنوان</a>
			</li>
			<li>
				<a href="javascript:jsVoid();"  data-toggle="dropdown" onclick="ajaxSorting('caseno');">رقم المهمة</a>
			</li>
			<li>
				<a href="javascript:jsVoid();"  data-toggle="dropdown" onclick="ajaxSorting('duedate');"> تاريخ الإستحقاق</a>
			</li>
			<li>
				<a href="javascript:jsVoid();"  data-toggle="dropdown" onclick="ajaxSorting('caseAt');">التعيين</a>
			</li>
...
<td id="topaction" class="">
		...
		if (ACT_TAB_ID && ACT_TAB_ID > 1) {
			...
			<li class="pop_li">
			    ...
			    <a href="javascript:void(0);" class="select_button_ftop" onclick="newcategorytab();" rel="tooltip" title="إعدادات تبويب المهام">
...
<div class="page-wrapper" id="actvt_section" style="display:none">
	...
	<div id="Upcoming"></div>
	<div id="moreOverdueloader" class="moreOverdueloader">جار تحميل المهام . . .</div>
	<hr/>
	<div id="Overdue"></div>
	<hr/>
