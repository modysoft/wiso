...
$gmdate = $this->Tmzone->GetDateTime(SES_TIMEZONE, TZ_GMT, TZ_DST, TZ_CODE, GMT_DATE, "date");
	...
	<div class="due_task_list">المهام المتأخرة</div>
	<?php } ?>
	<?php if($value[0]['todos_type']=='td' && !$td_label){ $td_label = 1; ?>
	<div class="due_task_list up_task_list">المهام المستقبلية</div>
	<?php } ?>
	...
	<div class="listdv">
		...
		<div class="fr" style="font-size:12px;">
		    ...
		    <?php if($is_overdue) {?>
			<span class="over-due" title="<?php echo $due_date;?>">المتأخر</span>
		    <?php } else {?>
	...
	<div class="mytask_txt">لا مهام مخصصة لك</div>
