...
<?php if(SES_TYPE == 1 || SES_TYPE == 2){ ?>
     ...
     <a href="javascript:void(0);" style="line-height:15px" class="makeHover" onClick="openUsPopup('add_user','<?php echo $proj_id; ?>','<?php echo urlencode($prj_name); ?>'),'1'"><div>إضافة مستخدم</div></a></div>
<?php } ?>
<?php */ ?>
<!-- Add user option end -->
<?php } ?>
