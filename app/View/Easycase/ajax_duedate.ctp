<li>
	...
	<font onClick="checkboxdueDate('any','text');filterRequest('duedate');" >&nbsp;أي وقت</font>
    </a>
</li>
...
<!--<li>
	...
	<font onClick="checkBox('duedate_one');checkboxdueDate('one','text');filterRequest('duedate');" >&nbsp;آخر ساعة</font>
    </a>
</li>-->
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkboxdueDate('overdue','text');filterRequest('duedate');" >&nbsp; متأخر</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkboxdueDate('24','text');filterRequest('duedate');" >&nbsp;اليوم</font>
    </a>
</li>
<!--<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('duedate_month');checkboxdueDate('month','text');filterRequest('duedate');" >&nbsp;الشهر القادم</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('duedate_year');checkboxdueDate('year','text');filterRequest('duedate');" >&nbsp;السنة القادمة</font>
    </a>
</li>-->
...
<li>
    <a href="javascript:void(0);">
		...
		<font onClick="checkboxcustom('custom_duedate','duedate_custom','due');" >&nbsp;تحديد النطاق</font>
    </a>
</li>
<div id="custom_duedate" <?php if(!$dt){?>style="display:none;"<?php }?> >
	...
	<div  class="cduedate_btn_div" style="text-align:center;margin-top: 5px;cursor:pointer">
		<button class="btn btn-primary cdate_btn" style="cursor: pointer;"  onclick="return searchduedate();">إبحث</button>
	</div>
</div>
<script>
$(function() {
