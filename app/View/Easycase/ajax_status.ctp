...
if(isset($query_All)){
	...
	<li>
		...
		<font <?php if(!$disabled) { ?> onClick="checkboxStatus('status_all','check');filterRequest('status');" <?php } ?> style="font-weight:bold;cursor:pointer">&nbsp;الكل (<?php echo $query_All; ?>)</font>
	    </a>
	</li>
	<li>
	    <a href="javascript:void(0);">
		...
		<font <?php if(!$disabled) { ?> onClick="checkboxStatus('status_close','text');filterRequest('status');" <?php } ?> style="color:#048404;cursor:pointer">&nbsp;المغلقة (<?php echo $query_Close; ?>)</font>
	    </a>
	</li>
	<li>
	    <a href="javascript:void(0);">
		...
		<span <?php if(!$disabled) { ?> onClick="checkboxStatus('status_new','text');filterRequest('status');" <?php } ?> style="color:#7f4240;cursor:pointer">&nbsp;جديدة (<?php echo $query_New; ?>)</span>
	    </a>
	</li>
	<li>
	    <a href="javascript:void(0);">
		...
		<span <?php if(!$disabled) { ?> onClick="checkboxStatus('status_open','text');filterRequest('status');" <?php } ?> style="color:#04407C;cursor:pointer">&nbsp;متقدمة (<?php echo $query_Open; ?>)</span>
	    </a>
	</li>
	...
	<?php /*?><div class="slide_menu_div1">
		...
		<span <?php if(!$disabled) { ?> onClick="checkboxStatus('status_start','text');filterRequest('status');" <?php } ?> style="color:#55A0C7;cursor:pointer">&nbsp;بدأت (<?php echo $query_Start; ?>)</span>
	</div><?php */?>
	...
	<li>
		...
		<span <?php if(!$disabled) { ?> onClick="checkboxStatus('status_resolve','text');filterRequest('status');" <?php } ?> style="color:#EF6807;cursor:pointer">&nbsp;منتهية (<?php echo $query_Resolve; ?>)</span>
	    </a>
	</li>
	<li>
	    <a href="javascript:void(0);">
		...
		<span onClick="checkboxStatus('status_file','text');filterRequest('status');" style="color:#3284C4;cursor:pointer">&nbsp;الملفات (<?php echo $query_Attch; ?>)</span>
	    </a>
	</li>
	...
	<li>
		...
		<span <?php if(!$disabled) { ?> onClick="checkboxStatus('status_upd','text');filterRequest('status');" <?php } ?> style="color:#000000;cursor:pointer">&nbsp;محدثة (<?php echo $query_Upd; ?>)</span>
	    </a>
	</li>
<?php
}
