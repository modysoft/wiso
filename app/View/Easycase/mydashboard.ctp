...
<ul class="sortable" id="ul_mydashboard">
	...
	<div class="sort_li_inner">
	    <div class="dshbd-hed">
		<div class="fl">أعمال للتنفيذ</div>
		<div class="fr active_icn portlet-header">
		    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="حرك"/>
		</div>
		<div class="fr active_icn">
			<a href="javascript:void(0);" onclick="creatask()" class="" style="color:#5191BD; font-size:13px;" rel="tooltip" title="إنشاء مهمـة">
	...
	<div class="sort_li_inner">
	    <div class="dshbd-hed">
		<div class="fl"> المشاريع الحالية</div>
		<div class="fr active_icn portlet-header">
		    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="Move"/>
		</div>
		<div class="fr active_icn">
			<a href="javascript:void(0);" onclick="newProject()" class="" style="color:#5191BD; font-size:13px;" rel="tooltip" title="إنشاء مشروع">
    ...
    <li class="sortable-li" id="list_<?php echo $value['id'];?>">
        <div class="sort_li_inner">
            <div class="dshbd-hed">
                <div class="fl">الأنشطة الحالية</div>
                <div class="fr active_icn portlet-header">
                    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="Move"/>
                </div>
				<div class="fr active_icn">
					<a href="javascript:void(0);" onclick="newUser()" class="" style="color:#5191BD; font-size:13px;" rel="tooltip" title="دعوة مستخدم">
						<i class="icon-create-proj"></i>
					</a>
				</div>
                <div class="cb"></div>
    ...
    <li class="sortable-li" id="list_<?php echo $value['id'];?>">
        <div class="sort_li_inner">
            <div class="dshbd-hed">
                <div class="fl">تفاصيل الاستخدام</div>
                <div class="fr active_icn portlet-header">
                    <img width="16px" src="<?php echo HTTP_IMAGES; ?>images/active_dboard.png" rel="tooltip" title="Move"/>
                </div>
                <div class="cb"></div>
