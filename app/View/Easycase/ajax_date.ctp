<li>
	...
	<font onClick="checkBox('date_any');checkboxDate('any','text');filterRequest('time');" >&nbsp;أي وقت</font>
    </a>
</li>
...
<li>
	...
	<font onClick="checkBox('date_one');checkboxDate('one','text');filterRequest('time');" >&nbsp;آخر ساعة</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_24');checkboxDate('24','text');filterRequest('time');" >&nbsp;آخر ٢٤ ساعة</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_week');checkboxDate('week','text');filterRequest('time');">&nbsp;الأسبوع الفائت</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_month');checkboxDate('month','text');filterRequest('time');" >&nbsp;الشهر الفائت</font>
    </a>
</li>
<li>
    <a href="javascript:void(0);">
	...
	<font onClick="checkBox('date_year');checkboxDate('year','text');filterRequest('time');" >&nbsp;السنة الفائتة</font>
    </a>
</li>
...
<li>
	...
	<font onClick="checkBox('date_custom');checkboxcustom('custom_date','date_custom','');" >&nbsp;تحديد النطاق</font>
    </a>
</li>
