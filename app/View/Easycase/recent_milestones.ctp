<?php if(isset($recent_milestones) && !empty($recent_milestones)) {
	...
	<div class="listdv">
	    ...
	    <div>
		<div class="fl status-dta"><?php if($is_overdue) {?><span class="fnt_clr_rd">متأخر</span><?php } else {?>Due on <?php echo $due_date; }?> <?php if($project=='all'){ ?><a href="<?php echo HTTP_ROOT."dashboard/?project=".$value['Project']['uniq_id'];?>"><?php echo $value['Project']['name'];?></a><?php }?></div>
    ...
    <div class="fnt_clr_rd">لا معالم في المشروع </div>
<?php } ?>