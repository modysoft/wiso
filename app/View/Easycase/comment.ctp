		...
		<td align="right" valign="middle">
			<span style="display:none;" id="hover<?php echo $cmntId; ?>">
				...
				<span id="hoverPost<?php echo $cmntId; ?>" style="display:none;">
					<a href="javascript:void(0);" onclick="postCommentsEdit('<?php echo $cmntId; ?>','cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>','<?php echo $repid; ?>','<?php echo $count; ?>')">حفظ</a>
					<font size="1">or</font>
