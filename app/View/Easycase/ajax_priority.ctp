...
?>
	...
	<font onClick="checkboxPriority('priority_<?php echo $p; ?>','text');filterRequest('priority');" style="cursor:pointer;">
		&nbsp;
		<?php 
		if($p == "High") { echo "<font style='color:#AE432E'>عالي (".$query_pri_high.")</font>"; } elseif($p == "Medium") { echo "<font style='color:#28AF51'>متوسط (".$query_pri_medium.")</font>"; } else { echo "<font style='color:#AD9227'>منخفض (".$query_pri_low.")</font>"; }
		?>
	</font>
	</a>
	</li>
