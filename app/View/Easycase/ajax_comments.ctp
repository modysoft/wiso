			...
			<tr height="20px" >
				...
				<td align="right" valign="middle">
					...
					<span id="hoverEdit<?php echo $cmntId; ?>">
						<img src="<?php echo HTTP_IMAGES; ?>images/comments.gif" border="0" style="text-decoration:none;"/><a href="javascript:void(0);" onclick="openCommentEdit('cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>')">تعديل</a>
					</span>
					<span id="hoverPost<?php echo $cmntId; ?>" style="display:none;">
						<a href="javascript:void(0);" onclick="postCommentsEdit('<?php echo $cmntId; ?>','cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>','','')">حفظ</a>
						<font size="1">or</font>
						<a href="javascript:void(0);" onclick="openCommentEdit('cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>')">إلغاء</a>
						</span>
					</span>
					<?php
					}
