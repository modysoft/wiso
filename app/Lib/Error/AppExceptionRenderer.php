...
class AppExceptionRenderer extends ExceptionRenderer {
	...
	public function pdoError(PDOException $error) {	
		...
		$message = "<table cellpadding='1' cellspacing='1' align='left' width='100%'>
					<tr><td>&nbsp;</td></tr>
					<tr><td align='left' style='font-family:Arial;font-size:14px;'>،السلام عليكم </td></tr>
					<tr><td align='left' style='font-family:Arial;font-size:14px;'>يحاول المستخدم إجراء نشاط على نظام التشغيل ولكن يتعذر عليه المتابعة بسبب الخطأ أدناه </td></tr>
