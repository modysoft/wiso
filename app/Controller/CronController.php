...
//echo "<pre>";print_r($userInfo);//exit;
				...
				$typ_arr=array('1'=>'<font color="#763532">New</font>','2'=>'<font color="#244F7A">متقدمة</font>','3'=>'<font color="#387600">Closed</font>','4'=>'<font color="#55A0C7">Start</font>','5'=>'<font color="#EF6807">منتهية</font>');
		...
		foreach($getAllNot as $emlNot) { 
			...
			if(count($case_cming) || count($case_late)){
				...
				if(count($case_late) != 0){
					$str_case="<tr><td><table cellpadding='2' cellspacing='2' style='font:bold 14px Arial;'><tr><td style='color:#FF0000'>مهام متأخرة</td></tr><tr><td><table style='border:1px solid #ccc; border-radius:5px;width:100%;border-collapse:collapse;font-size:14px;font-family:Arial;box-shadow:0px 0px 7px #ccc;' cellpadding='4' cellspacing='4'><tr><td style='border-bottom:1px solid #ccc'>Task#</td><td style='border-bottom:1px solid #ccc'>Title</td><td style='border-bottom:1px solid #ccc'>Status</td><td style='border-bottom:1px solid #ccc'>Due Date</td><td style='border-bottom:1px solid #ccc;width: 90px;'>Project</td><td style='border-bottom:1px solid #ccc;width: 90px;'>Late By</td></tr>";

					$typ_arr=array('1'=>'<font color="#763532">New</font>','2'=>'<font color="#244F7A">متقدمة</font>','3'=>'<font color="#387600">مغلقة</font>','4'=>'<font color="#55A0C7">Start</font>','5'=>'<font color="#EF6807">منتهية</font>');
				...
				if(count($case_cming) != 0){ 
					...
					$typ_arr=array('1'=>'<font color="#763532">New</font>','2'=>'<font color="#244F7A">متقدمة</font>','3'=>'<font color="#387600">مغلقة</font>','4'=>'<font color="#55A0C7">بدأت</font>','5'=>'<font color="#EF6807">منتهية</font>');
			...
			if($dateSent != $dateToday && $nottime <= $curtime){
				...
				foreach($projArr as $prj){
					...
					if($query_All) {
						...
						$typ_arr=array('1'=>'<font color="#AE432E">New</font>','2'=>'<font color="#244F7A">متقدمة</font>','3'=>'<font color="#387600">مغلقة</font>','4'=>'<font color="#244F7A">بدأت</font>','5'=>'<font color="#EF6807">منتهية</font>');
						...
						if(count($case_all) == 0){
							$sb_title = "لا يوجد مهام اليوم<br/><br/><br/>";
						}
 ...
 */
	function weeklyusagedetails(){//echo "<pre>";
		...
		foreach($user_details AS $key=>$val){
			...
			$message_top = '<div style="font-family:verdana;font-size:12px;">،السلام عليكم  '.$val['User']['name'].'<br/><br/>هذا هو تقرير الاستخدام الأسبوعي,</div><br/><div style="clear:both"></div> ';
			//echo $prv_date."<br/>";
			...
			//if($hour=='07' && $min<30){
				...
				//if($userlogin[0][0]['notlogged']){
					if($userlogin[0][0]['notlogged']==$userlogin[0][0]['tot']){
						...
						$message .='<div style="font-size: 17px;">لم يقم أي مستخدم بتسجيل الدخول إلى النظام منذ الأسبوع الماضي</div><br/><br/>';
					}else{
						...
						$message .='<div style="font-size: 17px;"><b>'.$userlogin[0][0]['notlogged'].'</b> Out of <b>'.$userlogin[0][0]['tot'].'</b> لم يقم أي مستخدم بتسجيل الدخول إلى النظام منذ الأسبوع الماضي</div><br/><br/>';
					}
				//}
