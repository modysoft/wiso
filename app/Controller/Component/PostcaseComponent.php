...
##### Email Settings
                ...
                if ($postParam['Easycase']['legend'] == 1) {
                    ...
                    $emailbody = "تم وضع ملاحظة على المهمة";
                }
...
##### get Case Type
        ...
        if ($hid_type != 10) {
            ...
            if ($hid_priority == "NULL" || $hid_priority == "") {
                $pri = "<font  style='color:#AD9227;padding:0;margin:0;height:16px;'>منخفض</font>";
            } else if ($hid_priority == 0) {
                $pri = "<font style='color:#AE432E;padding:0;margin:0;height:16px;'>مرتفع</font>";
            } else if ($hid_priority == 1) {
                $pri = "<font style='color:#28AF51;padding:0;margin:0;height:16px;'>متوسط</font>";
            } else if ($hid_priority >= 2) {
                $pri = "<font style='color:#AD9227;padding:0;margin:0;height:16px;'>منخفض</font>";
            }
            $priRity = "<font color='#737373'><b>الأهمية:</b></font> " . $pri;
        } else {
            $priRity = "";
        }
...
//$projNameInSh = substr($projNameInSh,0,9).'...';
        ...
        $subject = EMAIL_SUBJ . ":" . $projName . ":#" . $projShortNcaseNumber . "-" . stripslashes(html_entity_decode($case_title, ENT_QUOTES));
        ...
        <font color='#737373'><b>Task#:</b></font> " . html_entity_decode( $case_no, ENT_QUOTES, 'UTF-8'). "
        </td>
        <td style='padding-left:10px;line-height:22px;font:14px Arial'>
        <font color='#737373'><b>Type:</b></font> "  . html_entity_decode($cseTyp, ENT_QUOTES, 'UTF-8') . "
        </td>
        </tr>
        <tr style='height:10px;'><td colspan='2'>&nbsp;</td></tr>
        <tr>
        <td align='left' style='line-height:22px;font:14px Arial'>" .  html_entity_decode($priRity, ENT_QUOTES, 'UTF-8') . "</td>
        <td style='padding-left:10px;line-height:22px;font:14px Arial'>" .html_entity_decode( $msg , ENT_QUOTES, 'UTF-8'). "</td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <p>
        <font color='#737373'><b>" .html_entity_decode( $postingName, ENT_QUOTES,'UTF-8') . " " .html_entity_decode( $emailbody , ENT_QUOTES,'UTF-8'). "</b></font>
        </p>
        <p>
        " . stripslashes(html_entity_decode($respond,ENT_QUOTES)) . "
        </p>
        <p>
        " . $allfiles . "
        </p>
...
السلام عليكم، " . ucfirst(trim($user['name'])) . "
</td>
</tr>
<tr>
<td style='font:14px Arial;padding:10px;'>
هذا هو تذكير لنشر التحديثات الخاصة بك اليوم إلى نظام المهام. ما عليك سوى الرد على هذه الرسالة الإلكترونية مع التحديثات، وسوف تتم إضافتها إلى المشروع
<br/><br/><br/><b>NOTE:</b> لا تغير موضوع الرسالة أثناء الرد.<br/><br/>
</td>
</tr>
<tr>
...
<tr><td style='font:13px Arial;color:#737373;'> <b>المتابعة اليومية</b> التنبيه لك</td></tr>
</table></td></tr>
";
...
//			    
                            if (@$findEmail['User']['id']) {
                                $subject = " دعوة للمشاركة في ". CMP_SITE ." من إدارة التخطيط والمتابعة " ;
                                $ext_user = 1;
                            } else {
                                $subject = " دعوة للمشاركة في برنامج المهام من إدارة التخطيط والمتابعة";
                            }
