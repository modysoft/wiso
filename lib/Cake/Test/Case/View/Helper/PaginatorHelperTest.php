 ...
 */
	public function testSortLinks() {
		...
		$result = $this->Paginator->sort('title');
		$this->assertRegExp('/\/accounts\/index\/param\/sort:title\/direction:asc" class="desc">العنوان<\/a>$/', $result);

		$this->Paginator->request->params['paging']['Article']['options']['order'] = array('Article.title' => 'asc');
		$this->Paginator->request->params['paging']['Article']['options']['sort'] = null;
		$result = $this->Paginator->sort('title');
		$this->assertRegExp('/\/accounts\/index\/param\/sort:title\/direction:desc" class="asc">العنوان<\/a>$/', $result);
		...
		$this->assertRegExp('/\/accounts\/index\/param\/sort:title\/direction:desc" class="foo asc">العنوان<\/a>$/', $result);
	}
